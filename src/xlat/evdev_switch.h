...
static const struct xlat_data evdev_switch_xdata[] = {
 ...
 [SW_MACHINE_COVER] = XLAT(SW_MACHINE_COVER),
 #define XLAT_VAL_16 ((unsigned) (SW_MACHINE_COVER))
 #define XLAT_STR_16 STRINGIFY(SW_MACHINE_COVER)
 [SW_USB_INSERT] = XLAT(SW_USB_INSERT),
 #define XLAT_VAL_17 ((unsigned) (SW_USB_INSERT))
 #define XLAT_STR_17 STRINGIFY(SW_USB_INSERT)
};
static
