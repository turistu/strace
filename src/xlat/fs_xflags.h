...
static const struct xlat_data fs_xflags_xdata[] = {
 ...
 XLAT(FS_XFLAG_VERITY),
 #define XLAT_VAL_16 ((unsigned) (FS_XFLAG_VERITY))
 #define XLAT_STR_16 STRINGIFY(FS_XFLAG_VERITY)
 XLAT(FS_XFLAG_HASATTR),
 #define XLAT_VAL_17 ((unsigned) (FS_XFLAG_HASATTR))
 #define XLAT_STR_17 STRINGIFY(FS_XFLAG_HASATTR)
 XLAT(FS_XFLAG_CASEFOLD),
 #define XLAT_VAL_18 ((unsigned) (FS_XFLAG_CASEFOLD))
 #define XLAT_STR_18 STRINGIFY(FS_XFLAG_CASEFOLD)
 XLAT(FS_XFLAG_CASENONPRESERVING),
 #define XLAT_VAL_19 ((unsigned) (FS_XFLAG_CASENONPRESERVING))
 #define XLAT_STR_19 STRINGIFY(FS_XFLAG_CASENONPRESERVING)
};
