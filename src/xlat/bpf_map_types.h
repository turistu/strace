...
#endif
#if defined(BPF_MAP_TYPE_INSN_ARRAY) || (defined(HAVE_DECL_BPF_MAP_TYPE_INSN_ARRAY) && HAVE_DECL_BPF_MAP_TYPE_INSN_ARRAY)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((BPF_MAP_TYPE_INSN_ARRAY) == (34), "BPF_MAP_TYPE_INSN_ARRAY != 34");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define BPF_MAP_TYPE_INSN_ARRAY 34
#endif
#if defined(BPF_MAP_TYPE_RHASH) || (defined(HAVE_DECL_BPF_MAP_TYPE_RHASH) && HAVE_DECL_BPF_MAP_TYPE_RHASH)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((BPF_MAP_TYPE_RHASH) == (35), "BPF_MAP_TYPE_RHASH != 35");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data bpf_map_types_xdata[] = {
 ...
 [BPF_MAP_TYPE_INSN_ARRAY] = XLAT(BPF_MAP_TYPE_INSN_ARRAY),
 #define XLAT_VAL_34 ((unsigned) (BPF_MAP_TYPE_INSN_ARRAY))
 #define XLAT_STR_34 STRINGIFY(BPF_MAP_TYPE_INSN_ARRAY)
 [BPF_MAP_TYPE_RHASH] = XLAT(BPF_MAP_TYPE_RHASH),
 #define XLAT_VAL_35 ((unsigned) (BPF_MAP_TYPE_RHASH))
 #define XLAT_STR_35 STRINGIFY(BPF_MAP_TYPE_RHASH)
};
static
