...
static const struct xlat_data fcntlcmds_xdata[] = {
 ...
 XLAT(F_CANCELLK),
 #define XLAT_VAL_25 ((unsigned) (F_CANCELLK))
 #define XLAT_STR_25 STRINGIFY(F_CANCELLK)
 XLAT(F_DUPFD_CLOEXEC),
 #define XLAT_VAL_26 ((unsigned) (F_DUPFD_CLOEXEC))
 #define XLAT_STR_26 STRINGIFY(F_DUPFD_CLOEXEC)
 XLAT(F_SETPIPE_SZ),
 #define XLAT_VAL_27 ((unsigned) (F_SETPIPE_SZ))
 #define XLAT_STR_27 STRINGIFY(F_SETPIPE_SZ)
 XLAT(F_GETPIPE_SZ),
 #define XLAT_VAL_28 ((unsigned) (F_GETPIPE_SZ))
 #define XLAT_STR_28 STRINGIFY(F_GETPIPE_SZ)
 XLAT(F_ADD_SEALS),
 #define XLAT_VAL_29 ((unsigned) (F_ADD_SEALS))
 #define XLAT_STR_29 STRINGIFY(F_ADD_SEALS)
 XLAT(F_GET_SEALS),
 #define XLAT_VAL_30 ((unsigned) (F_GET_SEALS))
 #define XLAT_STR_30 STRINGIFY(F_GET_SEALS)
};
static
