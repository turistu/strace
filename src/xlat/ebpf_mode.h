...
#endif
#if defined(BPF_ATOMIC) || (defined(HAVE_DECL_BPF_ATOMIC) && HAVE_DECL_BPF_ATOMIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((BPF_ATOMIC) == (0xc0), "BPF_ATOMIC != 0xc0");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data ebpf_mode_xdata[] = {
 ...
 XLAT(BPF_ATOMIC),
 #define XLAT_VAL_5 ((unsigned) (BPF_ATOMIC))
 #define XLAT_STR_5 STRINGIFY(BPF_ATOMIC)
};
static
