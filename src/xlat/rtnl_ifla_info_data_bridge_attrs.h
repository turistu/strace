...
static_assert((IFLA_BR_FDB_N_LEARNED) == (48), "IFLA_BR_FDB_N_LEARNED != 48");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((IFLA_BR_FDB_MAX_LEARNED) == (49), "IFLA_BR_FDB_MAX_LEARNED != 49");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((IFLA_BR_STP_MODE) == (50), "IFLA_BR_STP_MODE != 50");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#undef XLAT_PREV_VAL
...
static const struct xlat_data rtnl_ifla_info_data_bridge_attrs_xdata[] = {
 ...
 [IFLA_BR_FDB_N_LEARNED] = XLAT(IFLA_BR_FDB_N_LEARNED),
 #define XLAT_VAL_48 ((unsigned) (IFLA_BR_FDB_N_LEARNED))
 #define XLAT_STR_48 STRINGIFY(IFLA_BR_FDB_N_LEARNED)
 [IFLA_BR_FDB_MAX_LEARNED] = XLAT(IFLA_BR_FDB_MAX_LEARNED),
 #define XLAT_VAL_49 ((unsigned) (IFLA_BR_FDB_MAX_LEARNED))
 #define XLAT_STR_49 STRINGIFY(IFLA_BR_FDB_MAX_LEARNED)
 [IFLA_BR_STP_MODE] = XLAT(IFLA_BR_STP_MODE),
 #define XLAT_VAL_50 ((unsigned) (IFLA_BR_STP_MODE))
 #define XLAT_STR_50 STRINGIFY(IFLA_BR_STP_MODE)
};
static
