...
static const struct xlat_data v4l2_control_flags_xdata[] = {
 ...
 XLAT(V4L2_CTRL_FLAG_HAS_WHICH_MIN_MAX),
 #define XLAT_VAL_12 ((unsigned) (V4L2_CTRL_FLAG_HAS_WHICH_MIN_MAX))
 #define XLAT_STR_12 STRINGIFY(V4L2_CTRL_FLAG_HAS_WHICH_MIN_MAX)
};
