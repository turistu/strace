...
#endif
#if defined(IPPROTO_AGGFRAG) || (defined(HAVE_DECL_IPPROTO_AGGFRAG) && HAVE_DECL_IPPROTO_AGGFRAG)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((IPPROTO_AGGFRAG) == (144), "IPPROTO_AGGFRAG != 144");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#if defined(IPPROTO_AGGFRAG) || (defined(HAVE_DECL_IPPROTO_AGGFRAG) && HAVE_DECL_IPPROTO_AGGFRAG)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (IPPROTO_AGGFRAG)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: IPPROTO_AGGFRAG"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (IPPROTO_AGGFRAG)
#endif
...
static const struct xlat_data inet_protocols_xdata[] = {
 ...
 XLAT(IPPROTO_AGGFRAG),
 #define XLAT_VAL_32 ((unsigned) (IPPROTO_AGGFRAG))
 #define XLAT_STR_32 STRINGIFY(IPPROTO_AGGFRAG)
 XLAT(IPPROTO_RAW),
 #define XLAT_VAL_33 ((unsigned) (IPPROTO_RAW))
 #define XLAT_STR_33 STRINGIFY(IPPROTO_RAW)
 XLAT(IPPROTO_SMC),
 #define XLAT_VAL_34 ((unsigned) (IPPROTO_SMC))
 #define XLAT_STR_34 STRINGIFY(IPPROTO_SMC)
 XLAT(IPPROTO_MPTCP),
 #define XLAT_VAL_35 ((unsigned) (IPPROTO_MPTCP))
 #define XLAT_STR_35 STRINGIFY(IPPROTO_MPTCP)
};
