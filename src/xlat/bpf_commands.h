...
#endif
#if defined(BPF_PROG_STREAM_READ_BY_FD) || (defined(HAVE_DECL_BPF_PROG_STREAM_READ_BY_FD) && HAVE_DECL_BPF_PROG_STREAM_READ_BY_FD)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((BPF_PROG_STREAM_READ_BY_FD) == (37), "BPF_PROG_STREAM_READ_BY_FD != 37");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define BPF_PROG_STREAM_READ_BY_FD 37
#endif
#if defined(BPF_PROG_ASSOC_STRUCT_OPS) || (defined(HAVE_DECL_BPF_PROG_ASSOC_STRUCT_OPS) && HAVE_DECL_BPF_PROG_ASSOC_STRUCT_OPS)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((BPF_PROG_ASSOC_STRUCT_OPS) == (38), "BPF_PROG_ASSOC_STRUCT_OPS != 38");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data bpf_commands_xdata[] = {
 ...
 [BPF_PROG_STREAM_READ_BY_FD] = XLAT(BPF_PROG_STREAM_READ_BY_FD),
 #define XLAT_VAL_37 ((unsigned) (BPF_PROG_STREAM_READ_BY_FD))
 #define XLAT_STR_37 STRINGIFY(BPF_PROG_STREAM_READ_BY_FD)
 [BPF_PROG_ASSOC_STRUCT_OPS] = XLAT(BPF_PROG_ASSOC_STRUCT_OPS),
 #define XLAT_VAL_38 ((unsigned) (BPF_PROG_ASSOC_STRUCT_OPS))
 #define XLAT_STR_38 STRINGIFY(BPF_PROG_ASSOC_STRUCT_OPS)
};
static
