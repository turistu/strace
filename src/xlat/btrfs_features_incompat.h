...
static const struct xlat_data btrfs_features_incompat_xdata[] = {
 ...
 XLAT_TYPE(uint64_t, BTRFS_FEATURE_INCOMPAT_REMAP_TREE),
 #define XLAT_VAL_16 ((uint64_t) (BTRFS_FEATURE_INCOMPAT_REMAP_TREE))
 #define XLAT_STR_16 STRINGIFY(BTRFS_FEATURE_INCOMPAT_REMAP_TREE)
};
