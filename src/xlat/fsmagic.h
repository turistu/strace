...
static const struct xlat_data fsmagic_xdata[] = {
 ...
 #define XLAT_VAL_63 ((unsigned) (GUEST_MEMFD_MAGIC))
 #define XLAT_STR_63 STRINGIFY(GUEST_MEMFD_MAGIC)
 XLAT(GPFS_SUPER_MAGIC),
 #define XLAT_VAL_64 ((unsigned) (GPFS_SUPER_MAGIC))
 #define XLAT_STR_64 STRINGIFY(GPFS_SUPER_MAGIC)
 XLAT(NULL_FS_MAGIC),
 #define XLAT_VAL_65 ((unsigned) (NULL_FS_MAGIC))
 #define XLAT_STR_65 STRINGIFY(NULL_FS_MAGIC)
 XLAT(PID_FS_MAGIC),
 #define XLAT_VAL_66 ((unsigned) (PID_FS_MAGIC))
 #define XLAT_STR_66 STRINGIFY(PID_FS_MAGIC)
 XLAT(PIPEFS_MAGIC),
 #define XLAT_VAL_67 ((unsigned) (PIPEFS_MAGIC))
 #define XLAT_STR_67 STRINGIFY(PIPEFS_MAGIC)
 XLAT(REISERFS_SUPER_MAGIC),
 #define XLAT_VAL_68 ((unsigned) (REISERFS_SUPER_MAGIC))
 #define XLAT_STR_68 STRINGIFY(REISERFS_SUPER_MAGIC)
 XLAT(SECRETMEM_MAGIC),
 #define XLAT_VAL_69 ((unsigned) (SECRETMEM_MAGIC))
 #define XLAT_STR_69 STRINGIFY(SECRETMEM_MAGIC)
 XLAT(AFS_SUPER_MAGIC),
 #define XLAT_VAL_70 ((unsigned) (AFS_SUPER_MAGIC))
 #define XLAT_STR_70 STRINGIFY(AFS_SUPER_MAGIC)
 XLAT(NTFS_SB_MAGIC),
 #define XLAT_VAL_71 ((unsigned) (NTFS_SB_MAGIC))
 #define XLAT_STR_71 STRINGIFY(NTFS_SB_MAGIC)
 XLAT(SOCKFS_MAGIC),
 #define XLAT_VAL_72 ((unsigned) (SOCKFS_MAGIC))
 #define XLAT_STR_72 STRINGIFY(SOCKFS_MAGIC)
 XLAT(UFS_CIGAM),
 #define XLAT_VAL_73 ((unsigned) (UFS_CIGAM))
 #define XLAT_STR_73 STRINGIFY(UFS_CIGAM)
 XLAT(VZFS_SUPER_MAGIC),
 #define XLAT_VAL_74 ((unsigned) (VZFS_SUPER_MAGIC))
 #define XLAT_STR_74 STRINGIFY(VZFS_SUPER_MAGIC)
 XLAT(STACK_END_MAGIC),
 #define XLAT_VAL_75 ((unsigned) (STACK_END_MAGIC))
 #define XLAT_STR_75 STRINGIFY(STACK_END_MAGIC)
 XLAT(ZSMALLOC_MAGIC),
 #define XLAT_VAL_76 ((unsigned) (ZSMALLOC_MAGIC))
 #define XLAT_STR_76 STRINGIFY(ZSMALLOC_MAGIC)
 XLAT(XFS_SUPER_MAGIC),
 #define XLAT_VAL_77 ((unsigned) (XFS_SUPER_MAGIC))
 #define XLAT_STR_77 STRINGIFY(XFS_SUPER_MAGIC)
 XLAT(AAFS_MAGIC),
 #define XLAT_VAL_78 ((unsigned) (AAFS_MAGIC))
 #define XLAT_STR_78 STRINGIFY(AAFS_MAGIC)
 XLAT(ZONEFS_MAGIC),
 #define XLAT_VAL_79 ((unsigned) (ZONEFS_MAGIC))
 #define XLAT_STR_79 STRINGIFY(ZONEFS_MAGIC)
 XLAT(PSTOREFS_MAGIC),
 #define XLAT_VAL_80 ((unsigned) (PSTOREFS_MAGIC))
 #define XLAT_STR_80 STRINGIFY(PSTOREFS_MAGIC)
 XLAT(AUFS_SUPER_MAGIC),
 #define XLAT_VAL_81 ((unsigned) (AUFS_SUPER_MAGIC))
 #define XLAT_STR_81 STRINGIFY(AUFS_SUPER_MAGIC)
 XLAT(BDEVFS_MAGIC),
 #define XLAT_VAL_82 ((unsigned) (BDEVFS_MAGIC))
 #define XLAT_STR_82 STRINGIFY(BDEVFS_MAGIC)
 XLAT(CONFIGFS_MAGIC),
 #define XLAT_VAL_83 ((unsigned) (CONFIGFS_MAGIC))
 #define XLAT_STR_83 STRINGIFY(CONFIGFS_MAGIC)
 XLAT(SYSFS_MAGIC),
 #define XLAT_VAL_84 ((unsigned) (SYSFS_MAGIC))
 #define XLAT_STR_84 STRINGIFY(SYSFS_MAGIC)
 XLAT(CGROUP2_SUPER_MAGIC),
 #define XLAT_VAL_85 ((unsigned) (CGROUP2_SUPER_MAGIC))
 #define XLAT_STR_85 STRINGIFY(CGROUP2_SUPER_MAGIC)
 XLAT(DEBUGFS_MAGIC),
 #define XLAT_VAL_86 ((unsigned) (DEBUGFS_MAGIC))
 #define XLAT_STR_86 STRINGIFY(DEBUGFS_MAGIC)
 XLAT(DAXFS_MAGIC),
 #define XLAT_VAL_87 ((unsigned) (DAXFS_MAGIC))
 #define XLAT_STR_87 STRINGIFY(DAXFS_MAGIC)
 XLAT(FUSE_CTL_SUPER_MAGIC),
 #define XLAT_VAL_88 ((unsigned) (FUSE_CTL_SUPER_MAGIC))
 #define XLAT_STR_88 STRINGIFY(FUSE_CTL_SUPER_MAGIC)
 XLAT(FUSE_SUPER_MAGIC),
 #define XLAT_VAL_89 ((unsigned) (FUSE_SUPER_MAGIC))
 #define XLAT_STR_89 STRINGIFY(FUSE_SUPER_MAGIC)
 XLAT(QNX6_SUPER_MAGIC),
 #define XLAT_VAL_90 ((unsigned) (QNX6_SUPER_MAGIC))
 #define XLAT_STR_90 STRINGIFY(QNX6_SUPER_MAGIC)
 XLAT(AFS_FS_MAGIC),
 #define XLAT_VAL_91 ((unsigned) (AFS_FS_MAGIC))
 #define XLAT_STR_91 STRINGIFY(AFS_FS_MAGIC)
 XLAT(BINDERFS_SUPER_MAGIC),
 #define XLAT_VAL_92 ((unsigned) (BINDERFS_SUPER_MAGIC))
 #define XLAT_STR_92 STRINGIFY(BINDERFS_SUPER_MAGIC)
 XLAT(NSFS_MAGIC),
 #define XLAT_VAL_93 ((unsigned) (NSFS_MAGIC))
 #define XLAT_STR_93 STRINGIFY(NSFS_MAGIC)
 XLAT(SECURITYFS_MAGIC),
 #define XLAT_VAL_94 ((unsigned) (SECURITYFS_MAGIC))
 #define XLAT_STR_94 STRINGIFY(SECURITYFS_MAGIC)
 XLAT(SQUASHFS_MAGIC),
 #define XLAT_VAL_95 ((unsigned) (SQUASHFS_MAGIC))
 #define XLAT_STR_95 STRINGIFY(SQUASHFS_MAGIC)
 XLAT(BTRFS_TEST_MAGIC),
 #define XLAT_VAL_96 ((unsigned) (BTRFS_TEST_MAGIC))
 #define XLAT_STR_96 STRINGIFY(BTRFS_TEST_MAGIC)
 XLAT(CODA_SUPER_MAGIC),
 #define XLAT_VAL_97 ((unsigned) (CODA_SUPER_MAGIC))
 #define XLAT_STR_97 STRINGIFY(CODA_SUPER_MAGIC)
 XLAT(OCFS2_SUPER_MAGIC),
 #define XLAT_VAL_98 ((unsigned) (OCFS2_SUPER_MAGIC))
 #define XLAT_STR_98 STRINGIFY(OCFS2_SUPER_MAGIC)
 XLAT(TRACEFS_MAGIC),
 #define XLAT_VAL_99 ((unsigned) (TRACEFS_MAGIC))
 #define XLAT_STR_99 STRINGIFY(TRACEFS_MAGIC)
 XLAT(OVERLAYFS_SUPER_MAGIC),
 #define XLAT_VAL_100 ((unsigned) (OVERLAYFS_SUPER_MAGIC))
 #define XLAT_STR_100 STRINGIFY(OVERLAYFS_SUPER_MAGIC)
 XLAT(RAMFS_MAGIC),
 #define XLAT_VAL_101 ((unsigned) (RAMFS_MAGIC))
 #define XLAT_STR_101 STRINGIFY(RAMFS_MAGIC)
 XLAT(BTRFS_SUPER_MAGIC),
 #define XLAT_VAL_102 ((unsigned) (BTRFS_SUPER_MAGIC))
 #define XLAT_STR_102 STRINGIFY(BTRFS_SUPER_MAGIC)
 XLAT(HUGETLBFS_MAGIC),
 #define XLAT_VAL_103 ((unsigned) (HUGETLBFS_MAGIC))
 #define XLAT_STR_103 STRINGIFY(HUGETLBFS_MAGIC)
 XLAT(VXFS_SUPER_MAGIC),
 #define XLAT_VAL_104 ((unsigned) (VXFS_SUPER_MAGIC))
 #define XLAT_STR_104 STRINGIFY(VXFS_SUPER_MAGIC)
 XLAT(XENFS_SUPER_MAGIC),
 #define XLAT_VAL_105 ((unsigned) (XENFS_SUPER_MAGIC))
 #define XLAT_STR_105 STRINGIFY(XENFS_SUPER_MAGIC)
 XLAT(PPC_CMM_MAGIC),
 #define XLAT_VAL_106 ((unsigned) (PPC_CMM_MAGIC))
 #define XLAT_STR_106 STRINGIFY(PPC_CMM_MAGIC)
 XLAT(LOGFS_MAGIC),
 #define XLAT_VAL_107 ((unsigned) (LOGFS_MAGIC))
 #define XLAT_STR_107 STRINGIFY(LOGFS_MAGIC)
 XLAT(BCACHEFS_SUPER_MAGIC),
 #define XLAT_VAL_108 ((unsigned) (BCACHEFS_SUPER_MAGIC))
 #define XLAT_STR_108 STRINGIFY(BCACHEFS_SUPER_MAGIC)
 XLAT(BPF_FS_MAGIC),
 #define XLAT_VAL_109 ((unsigned) (BPF_FS_MAGIC))
 #define XLAT_STR_109 STRINGIFY(BPF_FS_MAGIC)
 XLAT(EFIVARFS_MAGIC),
 #define XLAT_VAL_110 ((unsigned) (EFIVARFS_MAGIC))
 #define XLAT_STR_110 STRINGIFY(EFIVARFS_MAGIC)
 XLAT(EROFS_SUPER_MAGIC_V1),
 #define XLAT_VAL_111 ((unsigned) (EROFS_SUPER_MAGIC_V1))
 #define XLAT_STR_111 STRINGIFY(EROFS_SUPER_MAGIC_V1)
 XLAT(F2FS_SUPER_MAGIC),
 #define XLAT_VAL_112 ((unsigned) (F2FS_SUPER_MAGIC))
 #define XLAT_STR_112 STRINGIFY(F2FS_SUPER_MAGIC)
 XLAT(SELINUX_MAGIC),
 #define XLAT_VAL_113 ((unsigned) (SELINUX_MAGIC))
 #define XLAT_STR_113 STRINGIFY(SELINUX_MAGIC)
 XLAT(HPFS_SUPER_MAGIC),
 #define XLAT_VAL_114 ((unsigned) (HPFS_SUPER_MAGIC))
 #define XLAT_STR_114 STRINGIFY(HPFS_SUPER_MAGIC)
 XLAT(SMB2_SUPER_MAGIC),
 #define XLAT_VAL_115 ((unsigned) (SMB2_SUPER_MAGIC))
 #define XLAT_STR_115 STRINGIFY(SMB2_SUPER_MAGIC)
 XLAT(CIFS_SUPER_MAGIC),
 #define XLAT_VAL_116 ((unsigned) (CIFS_SUPER_MAGIC))
 #define XLAT_STR_116 STRINGIFY(CIFS_SUPER_MAGIC)
};
