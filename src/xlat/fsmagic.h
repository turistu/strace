...
#endif
#if defined(LL_SUPER_MAGIC) || (defined(HAVE_DECL_LL_SUPER_MAGIC) && HAVE_DECL_LL_SUPER_MAGIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((LL_SUPER_MAGIC) == (0x0bd00bd0), "LL_SUPER_MAGIC != 0x0bd00bd0");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#if defined(LL_SUPER_MAGIC) || (defined(HAVE_DECL_LL_SUPER_MAGIC) && HAVE_DECL_LL_SUPER_MAGIC)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (LL_SUPER_MAGIC)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: LL_SUPER_MAGIC"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (LL_SUPER_MAGIC)
#endif
#if defined(LUSTRE_SUPER_MAGIC) || (defined(HAVE_DECL_LUSTRE_SUPER_MAGIC) && HAVE_DECL_LUSTRE_SUPER_MAGIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((LUSTRE_SUPER_MAGIC) == (0x0bd00bd1), "LUSTRE_SUPER_MAGIC != 0x0bd00bd1");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#if defined(LUSTRE_SUPER_MAGIC) || (defined(HAVE_DECL_LUSTRE_SUPER_MAGIC) && HAVE_DECL_LUSTRE_SUPER_MAGIC)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (LUSTRE_SUPER_MAGIC)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: LUSTRE_SUPER_MAGIC"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (LUSTRE_SUPER_MAGIC)
#endif
...
#endif
#if defined(FAIL_FS_MAGIC) || (defined(HAVE_DECL_FAIL_FS_MAGIC) && HAVE_DECL_FAIL_FS_MAGIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FAIL_FS_MAGIC) == (0x4641494c), "FAIL_FS_MAGIC != 0x4641494c");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FAIL_FS_MAGIC 0x4641494c
#endif
#if defined(FAIL_FS_MAGIC) || (defined(HAVE_DECL_FAIL_FS_MAGIC) && HAVE_DECL_FAIL_FS_MAGIC)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (FAIL_FS_MAGIC)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: FAIL_FS_MAGIC"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (FAIL_FS_MAGIC)
#endif
#if defined(GUEST_MEMFD_MAGIC) || (defined(HAVE_DECL_GUEST_MEMFD_MAGIC) && HAVE_DECL_GUEST_MEMFD_MAGIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((GUEST_MEMFD_MAGIC) == (0x474d454d), "GUEST_MEMFD_MAGIC != 0x474d454d");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#if defined(GUEST_MEMFD_MAGIC) || (defined(HAVE_DECL_GUEST_MEMFD_MAGIC) && HAVE_DECL_GUEST_MEMFD_MAGIC)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (GUEST_MEMFD_MAGIC)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: GUEST_MEMFD_MAGIC"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (GUEST_MEMFD_MAGIC)
#endif
...
#endif
#if defined(NULL_FS_MAGIC) || (defined(HAVE_DECL_NULL_FS_MAGIC) && HAVE_DECL_NULL_FS_MAGIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((NULL_FS_MAGIC) == (0x4E554C4C), "NULL_FS_MAGIC != 0x4E554C4C");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#if defined(NULL_FS_MAGIC) || (defined(HAVE_DECL_NULL_FS_MAGIC) && HAVE_DECL_NULL_FS_MAGIC)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (NULL_FS_MAGIC)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: NULL_FS_MAGIC"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (NULL_FS_MAGIC)
#endif
#if defined(PID_FS_MAGIC) || (defined(HAVE_DECL_PID_FS_MAGIC) && HAVE_DECL_PID_FS_MAGIC)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((PID_FS_MAGIC) == (0x50494446), "PID_FS_MAGIC != 0x50494446");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#if defined(PID_FS_MAGIC) || (defined(HAVE_DECL_PID_FS_MAGIC) && HAVE_DECL_PID_FS_MAGIC)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (PID_FS_MAGIC)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: PID_FS_MAGIC"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (PID_FS_MAGIC)
#endif
...
static const struct xlat_data fsmagic_xdata[] = {
 ...
 XLAT(LL_SUPER_MAGIC),
 #define XLAT_VAL_46 ((unsigned) (LL_SUPER_MAGIC))
 #define XLAT_STR_46 STRINGIFY(LL_SUPER_MAGIC)
 XLAT(LUSTRE_SUPER_MAGIC),
 #define XLAT_VAL_47 ((unsigned) (LUSTRE_SUPER_MAGIC))
 #define XLAT_STR_47 STRINGIFY(LUSTRE_SUPER_MAGIC)
 XLAT(MTD_INODE_FS_MAGIC),
 #define XLAT_VAL_48 ((unsigned) (MTD_INODE_FS_MAGIC))
 #define XLAT_STR_48 STRINGIFY(MTD_INODE_FS_MAGIC)
 XLAT(BALLOON_KVM_MAGIC),
 #define XLAT_VAL_49 ((unsigned) (BALLOON_KVM_MAGIC))
 #define XLAT_STR_49 STRINGIFY(BALLOON_KVM_MAGIC)
 XLAT(UDF_SUPER_MAGIC),
 #define XLAT_VAL_50 ((unsigned) (UDF_SUPER_MAGIC))
 #define XLAT_STR_50 STRINGIFY(UDF_SUPER_MAGIC)
 XLAT(BFS_MAGIC),
 #define XLAT_VAL_51 ((unsigned) (BFS_MAGIC))
 #define XLAT_STR_51 STRINGIFY(BFS_MAGIC)
 XLAT(EXFAT_SUPER_MAGIC),
 #define XLAT_VAL_52 ((unsigned) (EXFAT_SUPER_MAGIC))
 #define XLAT_STR_52 STRINGIFY(EXFAT_SUPER_MAGIC)
 XLAT(UBIFS_SUPER_MAGIC),
 #define XLAT_VAL_53 ((unsigned) (UBIFS_SUPER_MAGIC))
 #define XLAT_STR_53 STRINGIFY(UBIFS_SUPER_MAGIC)
 XLAT(CRAMFS_MAGIC),
 #define XLAT_VAL_54 ((unsigned) (CRAMFS_MAGIC))
 #define XLAT_STR_54 STRINGIFY(CRAMFS_MAGIC)
 XLAT(ZFS_SUPER_MAGIC),
 #define XLAT_VAL_55 ((unsigned) (ZFS_SUPER_MAGIC))
 #define XLAT_STR_55 STRINGIFY(ZFS_SUPER_MAGIC)
 XLAT(JFS_SUPER_MAGIC),
 #define XLAT_VAL_56 ((unsigned) (JFS_SUPER_MAGIC))
 #define XLAT_STR_56 STRINGIFY(JFS_SUPER_MAGIC)
 XLAT(BEFS_SUPER_MAGIC),
 #define XLAT_VAL_57 ((unsigned) (BEFS_SUPER_MAGIC))
 #define XLAT_STR_57 STRINGIFY(BEFS_SUPER_MAGIC)
 XLAT(BINFMTFS_MAGIC),
 #define XLAT_VAL_58 ((unsigned) (BINFMTFS_MAGIC))
 #define XLAT_STR_58 STRINGIFY(BINFMTFS_MAGIC)
 XLAT(SMACK_MAGIC),
 #define XLAT_VAL_59 ((unsigned) (SMACK_MAGIC))
 #define XLAT_STR_59 STRINGIFY(SMACK_MAGIC)
 XLAT(DMA_BUF_MAGIC),
 #define XLAT_VAL_60 ((unsigned) (DMA_BUF_MAGIC))
 #define XLAT_STR_60 STRINGIFY(DMA_BUF_MAGIC)
 XLAT(CRAMFS_MAGIC_WEND),
 #define XLAT_VAL_61 ((unsigned) (CRAMFS_MAGIC_WEND))
 #define XLAT_STR_61 STRINGIFY(CRAMFS_MAGIC_WEND)
 XLAT(DEVMEM_MAGIC),
 #define XLAT_VAL_62 ((unsigned) (DEVMEM_MAGIC))
 #define XLAT_STR_62 STRINGIFY(DEVMEM_MAGIC)
 XLAT(FAIL_FS_MAGIC),
 #define XLAT_VAL_63 ((unsigned) (FAIL_FS_MAGIC))
 #define XLAT_STR_63 STRINGIFY(FAIL_FS_MAGIC)
 XLAT(GUEST_MEMFD_MAGIC),
 #define XLAT_VAL_64 ((unsigned) (GUEST_MEMFD_MAGIC))
 #define XLAT_STR_64 STRINGIFY(GUEST_MEMFD_MAGIC)
 XLAT(GPFS_SUPER_MAGIC),
 #define XLAT_VAL_65 ((unsigned) (GPFS_SUPER_MAGIC))
 #define XLAT_STR_65 STRINGIFY(GPFS_SUPER_MAGIC)
 XLAT(NULL_FS_MAGIC),
 #define XLAT_VAL_66 ((unsigned) (NULL_FS_MAGIC))
 #define XLAT_STR_66 STRINGIFY(NULL_FS_MAGIC)
 XLAT(PID_FS_MAGIC),
 #define XLAT_VAL_67 ((unsigned) (PID_FS_MAGIC))
 #define XLAT_STR_67 STRINGIFY(PID_FS_MAGIC)
 XLAT(PIPEFS_MAGIC),
 #define XLAT_VAL_68 ((unsigned) (PIPEFS_MAGIC))
 #define XLAT_STR_68 STRINGIFY(PIPEFS_MAGIC)
 XLAT(REISERFS_SUPER_MAGIC),
 #define XLAT_VAL_69 ((unsigned) (REISERFS_SUPER_MAGIC))
 #define XLAT_STR_69 STRINGIFY(REISERFS_SUPER_MAGIC)
 XLAT(SECRETMEM_MAGIC),
 #define XLAT_VAL_70 ((unsigned) (SECRETMEM_MAGIC))
 #define XLAT_STR_70 STRINGIFY(SECRETMEM_MAGIC)
 XLAT(AFS_SUPER_MAGIC),
 #define XLAT_VAL_71 ((unsigned) (AFS_SUPER_MAGIC))
 #define XLAT_STR_71 STRINGIFY(AFS_SUPER_MAGIC)
 XLAT(NTFS_SB_MAGIC),
 #define XLAT_VAL_72 ((unsigned) (NTFS_SB_MAGIC))
 #define XLAT_STR_72 STRINGIFY(NTFS_SB_MAGIC)
 XLAT(SOCKFS_MAGIC),
 #define XLAT_VAL_73 ((unsigned) (SOCKFS_MAGIC))
 #define XLAT_STR_73 STRINGIFY(SOCKFS_MAGIC)
 XLAT(UFS_CIGAM),
 #define XLAT_VAL_74 ((unsigned) (UFS_CIGAM))
 #define XLAT_STR_74 STRINGIFY(UFS_CIGAM)
 XLAT(VZFS_SUPER_MAGIC),
 #define XLAT_VAL_75 ((unsigned) (VZFS_SUPER_MAGIC))
 #define XLAT_STR_75 STRINGIFY(VZFS_SUPER_MAGIC)
 XLAT(STACK_END_MAGIC),
 #define XLAT_VAL_76 ((unsigned) (STACK_END_MAGIC))
 #define XLAT_STR_76 STRINGIFY(STACK_END_MAGIC)
 XLAT(ZSMALLOC_MAGIC),
 #define XLAT_VAL_77 ((unsigned) (ZSMALLOC_MAGIC))
 #define XLAT_STR_77 STRINGIFY(ZSMALLOC_MAGIC)
 XLAT(XFS_SUPER_MAGIC),
 #define XLAT_VAL_78 ((unsigned) (XFS_SUPER_MAGIC))
 #define XLAT_STR_78 STRINGIFY(XFS_SUPER_MAGIC)
 XLAT(AAFS_MAGIC),
 #define XLAT_VAL_79 ((unsigned) (AAFS_MAGIC))
 #define XLAT_STR_79 STRINGIFY(AAFS_MAGIC)
 XLAT(ZONEFS_MAGIC),
 #define XLAT_VAL_80 ((unsigned) (ZONEFS_MAGIC))
 #define XLAT_STR_80 STRINGIFY(ZONEFS_MAGIC)
 XLAT(PSTOREFS_MAGIC),
 #define XLAT_VAL_81 ((unsigned) (PSTOREFS_MAGIC))
 #define XLAT_STR_81 STRINGIFY(PSTOREFS_MAGIC)
 XLAT(AUFS_SUPER_MAGIC),
 #define XLAT_VAL_82 ((unsigned) (AUFS_SUPER_MAGIC))
 #define XLAT_STR_82 STRINGIFY(AUFS_SUPER_MAGIC)
 XLAT(BDEVFS_MAGIC),
 #define XLAT_VAL_83 ((unsigned) (BDEVFS_MAGIC))
 #define XLAT_STR_83 STRINGIFY(BDEVFS_MAGIC)
 XLAT(CONFIGFS_MAGIC),
 #define XLAT_VAL_84 ((unsigned) (CONFIGFS_MAGIC))
 #define XLAT_STR_84 STRINGIFY(CONFIGFS_MAGIC)
 XLAT(SYSFS_MAGIC),
 #define XLAT_VAL_85 ((unsigned) (SYSFS_MAGIC))
 #define XLAT_STR_85 STRINGIFY(SYSFS_MAGIC)
 XLAT(CGROUP2_SUPER_MAGIC),
 #define XLAT_VAL_86 ((unsigned) (CGROUP2_SUPER_MAGIC))
 #define XLAT_STR_86 STRINGIFY(CGROUP2_SUPER_MAGIC)
 XLAT(DEBUGFS_MAGIC),
 #define XLAT_VAL_87 ((unsigned) (DEBUGFS_MAGIC))
 #define XLAT_STR_87 STRINGIFY(DEBUGFS_MAGIC)
 XLAT(DAXFS_MAGIC),
 #define XLAT_VAL_88 ((unsigned) (DAXFS_MAGIC))
 #define XLAT_STR_88 STRINGIFY(DAXFS_MAGIC)
 XLAT(FUSE_CTL_SUPER_MAGIC),
 #define XLAT_VAL_89 ((unsigned) (FUSE_CTL_SUPER_MAGIC))
 #define XLAT_STR_89 STRINGIFY(FUSE_CTL_SUPER_MAGIC)
 XLAT(FUSE_SUPER_MAGIC),
 #define XLAT_VAL_90 ((unsigned) (FUSE_SUPER_MAGIC))
 #define XLAT_STR_90 STRINGIFY(FUSE_SUPER_MAGIC)
 XLAT(QNX6_SUPER_MAGIC),
 #define XLAT_VAL_91 ((unsigned) (QNX6_SUPER_MAGIC))
 #define XLAT_STR_91 STRINGIFY(QNX6_SUPER_MAGIC)
 XLAT(AFS_FS_MAGIC),
 #define XLAT_VAL_92 ((unsigned) (AFS_FS_MAGIC))
 #define XLAT_STR_92 STRINGIFY(AFS_FS_MAGIC)
 XLAT(BINDERFS_SUPER_MAGIC),
 #define XLAT_VAL_93 ((unsigned) (BINDERFS_SUPER_MAGIC))
 #define XLAT_STR_93 STRINGIFY(BINDERFS_SUPER_MAGIC)
 XLAT(NSFS_MAGIC),
 #define XLAT_VAL_94 ((unsigned) (NSFS_MAGIC))
 #define XLAT_STR_94 STRINGIFY(NSFS_MAGIC)
 XLAT(SECURITYFS_MAGIC),
 #define XLAT_VAL_95 ((unsigned) (SECURITYFS_MAGIC))
 #define XLAT_STR_95 STRINGIFY(SECURITYFS_MAGIC)
 XLAT(SQUASHFS_MAGIC),
 #define XLAT_VAL_96 ((unsigned) (SQUASHFS_MAGIC))
 #define XLAT_STR_96 STRINGIFY(SQUASHFS_MAGIC)
 XLAT(BTRFS_TEST_MAGIC),
 #define XLAT_VAL_97 ((unsigned) (BTRFS_TEST_MAGIC))
 #define XLAT_STR_97 STRINGIFY(BTRFS_TEST_MAGIC)
 XLAT(CODA_SUPER_MAGIC),
 #define XLAT_VAL_98 ((unsigned) (CODA_SUPER_MAGIC))
 #define XLAT_STR_98 STRINGIFY(CODA_SUPER_MAGIC)
 XLAT(OCFS2_SUPER_MAGIC),
 #define XLAT_VAL_99 ((unsigned) (OCFS2_SUPER_MAGIC))
 #define XLAT_STR_99 STRINGIFY(OCFS2_SUPER_MAGIC)
 XLAT(TRACEFS_MAGIC),
 #define XLAT_VAL_100 ((unsigned) (TRACEFS_MAGIC))
 #define XLAT_STR_100 STRINGIFY(TRACEFS_MAGIC)
 XLAT(OVERLAYFS_SUPER_MAGIC),
 #define XLAT_VAL_101 ((unsigned) (OVERLAYFS_SUPER_MAGIC))
 #define XLAT_STR_101 STRINGIFY(OVERLAYFS_SUPER_MAGIC)
 XLAT(RAMFS_MAGIC),
 #define XLAT_VAL_102 ((unsigned) (RAMFS_MAGIC))
 #define XLAT_STR_102 STRINGIFY(RAMFS_MAGIC)
 XLAT(BTRFS_SUPER_MAGIC),
 #define XLAT_VAL_103 ((unsigned) (BTRFS_SUPER_MAGIC))
 #define XLAT_STR_103 STRINGIFY(BTRFS_SUPER_MAGIC)
 XLAT(HUGETLBFS_MAGIC),
 #define XLAT_VAL_104 ((unsigned) (HUGETLBFS_MAGIC))
 #define XLAT_STR_104 STRINGIFY(HUGETLBFS_MAGIC)
 XLAT(VXFS_SUPER_MAGIC),
 #define XLAT_VAL_105 ((unsigned) (VXFS_SUPER_MAGIC))
 #define XLAT_STR_105 STRINGIFY(VXFS_SUPER_MAGIC)
 XLAT(XENFS_SUPER_MAGIC),
 #define XLAT_VAL_106 ((unsigned) (XENFS_SUPER_MAGIC))
 #define XLAT_STR_106 STRINGIFY(XENFS_SUPER_MAGIC)
 XLAT(PPC_CMM_MAGIC),
 #define XLAT_VAL_107 ((unsigned) (PPC_CMM_MAGIC))
 #define XLAT_STR_107 STRINGIFY(PPC_CMM_MAGIC)
 XLAT(LOGFS_MAGIC),
 #define XLAT_VAL_108 ((unsigned) (LOGFS_MAGIC))
 #define XLAT_STR_108 STRINGIFY(LOGFS_MAGIC)
 XLAT(BCACHEFS_SUPER_MAGIC),
 #define XLAT_VAL_109 ((unsigned) (BCACHEFS_SUPER_MAGIC))
 #define XLAT_STR_109 STRINGIFY(BCACHEFS_SUPER_MAGIC)
 XLAT(BPF_FS_MAGIC),
 #define XLAT_VAL_110 ((unsigned) (BPF_FS_MAGIC))
 #define XLAT_STR_110 STRINGIFY(BPF_FS_MAGIC)
 XLAT(EFIVARFS_MAGIC),
 #define XLAT_VAL_111 ((unsigned) (EFIVARFS_MAGIC))
 #define XLAT_STR_111 STRINGIFY(EFIVARFS_MAGIC)
 XLAT(EROFS_SUPER_MAGIC_V1),
 #define XLAT_VAL_112 ((unsigned) (EROFS_SUPER_MAGIC_V1))
 #define XLAT_STR_112 STRINGIFY(EROFS_SUPER_MAGIC_V1)
 XLAT(F2FS_SUPER_MAGIC),
 #define XLAT_VAL_113 ((unsigned) (F2FS_SUPER_MAGIC))
 #define XLAT_STR_113 STRINGIFY(F2FS_SUPER_MAGIC)
 XLAT(SELINUX_MAGIC),
 #define XLAT_VAL_114 ((unsigned) (SELINUX_MAGIC))
 #define XLAT_STR_114 STRINGIFY(SELINUX_MAGIC)
 XLAT(HPFS_SUPER_MAGIC),
 #define XLAT_VAL_115 ((unsigned) (HPFS_SUPER_MAGIC))
 #define XLAT_STR_115 STRINGIFY(HPFS_SUPER_MAGIC)
 XLAT(SMB2_SUPER_MAGIC),
 #define XLAT_VAL_116 ((unsigned) (SMB2_SUPER_MAGIC))
 #define XLAT_STR_116 STRINGIFY(SMB2_SUPER_MAGIC)
 XLAT(CIFS_SUPER_MAGIC),
 #define XLAT_VAL_117 ((unsigned) (CIFS_SUPER_MAGIC))
 #define XLAT_STR_117 STRINGIFY(CIFS_SUPER_MAGIC)
};
