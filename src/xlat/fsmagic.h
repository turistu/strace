...
static const struct xlat_data fsmagic_xdata[] = {
 ...
 #define XLAT_VAL_63 ((unsigned) (GPFS_SUPER_MAGIC))
 #define XLAT_STR_63 STRINGIFY(GPFS_SUPER_MAGIC)
 XLAT(PID_FS_MAGIC),
 #define XLAT_VAL_64 ((unsigned) (PID_FS_MAGIC))
 #define XLAT_STR_64 STRINGIFY(PID_FS_MAGIC)
 XLAT(PIPEFS_MAGIC),
 #define XLAT_VAL_65 ((unsigned) (PIPEFS_MAGIC))
 #define XLAT_STR_65 STRINGIFY(PIPEFS_MAGIC)
 XLAT(REISERFS_SUPER_MAGIC),
 #define XLAT_VAL_66 ((unsigned) (REISERFS_SUPER_MAGIC))
 #define XLAT_STR_66 STRINGIFY(REISERFS_SUPER_MAGIC)
 XLAT(SECRETMEM_MAGIC),
 #define XLAT_VAL_67 ((unsigned) (SECRETMEM_MAGIC))
 #define XLAT_STR_67 STRINGIFY(SECRETMEM_MAGIC)
 XLAT(AFS_SUPER_MAGIC),
 #define XLAT_VAL_68 ((unsigned) (AFS_SUPER_MAGIC))
 #define XLAT_STR_68 STRINGIFY(AFS_SUPER_MAGIC)
 XLAT(NTFS_SB_MAGIC),
 #define XLAT_VAL_69 ((unsigned) (NTFS_SB_MAGIC))
 #define XLAT_STR_69 STRINGIFY(NTFS_SB_MAGIC)
 XLAT(SOCKFS_MAGIC),
 #define XLAT_VAL_70 ((unsigned) (SOCKFS_MAGIC))
 #define XLAT_STR_70 STRINGIFY(SOCKFS_MAGIC)
 XLAT(UFS_CIGAM),
 #define XLAT_VAL_71 ((unsigned) (UFS_CIGAM))
 #define XLAT_STR_71 STRINGIFY(UFS_CIGAM)
 XLAT(VZFS_SUPER_MAGIC),
 #define XLAT_VAL_72 ((unsigned) (VZFS_SUPER_MAGIC))
 #define XLAT_STR_72 STRINGIFY(VZFS_SUPER_MAGIC)
 XLAT(STACK_END_MAGIC),
 #define XLAT_VAL_73 ((unsigned) (STACK_END_MAGIC))
 #define XLAT_STR_73 STRINGIFY(STACK_END_MAGIC)
 XLAT(ZSMALLOC_MAGIC),
 #define XLAT_VAL_74 ((unsigned) (ZSMALLOC_MAGIC))
 #define XLAT_STR_74 STRINGIFY(ZSMALLOC_MAGIC)
 XLAT(XFS_SUPER_MAGIC),
 #define XLAT_VAL_75 ((unsigned) (XFS_SUPER_MAGIC))
 #define XLAT_STR_75 STRINGIFY(XFS_SUPER_MAGIC)
 XLAT(AAFS_MAGIC),
 #define XLAT_VAL_76 ((unsigned) (AAFS_MAGIC))
 #define XLAT_STR_76 STRINGIFY(AAFS_MAGIC)
 XLAT(ZONEFS_MAGIC),
 #define XLAT_VAL_77 ((unsigned) (ZONEFS_MAGIC))
 #define XLAT_STR_77 STRINGIFY(ZONEFS_MAGIC)
 XLAT(PSTOREFS_MAGIC),
 #define XLAT_VAL_78 ((unsigned) (PSTOREFS_MAGIC))
 #define XLAT_STR_78 STRINGIFY(PSTOREFS_MAGIC)
 XLAT(AUFS_SUPER_MAGIC),
 #define XLAT_VAL_79 ((unsigned) (AUFS_SUPER_MAGIC))
 #define XLAT_STR_79 STRINGIFY(AUFS_SUPER_MAGIC)
 XLAT(BDEVFS_MAGIC),
 #define XLAT_VAL_80 ((unsigned) (BDEVFS_MAGIC))
 #define XLAT_STR_80 STRINGIFY(BDEVFS_MAGIC)
 XLAT(CONFIGFS_MAGIC),
 #define XLAT_VAL_81 ((unsigned) (CONFIGFS_MAGIC))
 #define XLAT_STR_81 STRINGIFY(CONFIGFS_MAGIC)
 XLAT(SYSFS_MAGIC),
 #define XLAT_VAL_82 ((unsigned) (SYSFS_MAGIC))
 #define XLAT_STR_82 STRINGIFY(SYSFS_MAGIC)
 XLAT(CGROUP2_SUPER_MAGIC),
 #define XLAT_VAL_83 ((unsigned) (CGROUP2_SUPER_MAGIC))
 #define XLAT_STR_83 STRINGIFY(CGROUP2_SUPER_MAGIC)
 XLAT(DEBUGFS_MAGIC),
 #define XLAT_VAL_84 ((unsigned) (DEBUGFS_MAGIC))
 #define XLAT_STR_84 STRINGIFY(DEBUGFS_MAGIC)
 XLAT(DAXFS_MAGIC),
 #define XLAT_VAL_85 ((unsigned) (DAXFS_MAGIC))
 #define XLAT_STR_85 STRINGIFY(DAXFS_MAGIC)
 XLAT(FUSE_CTL_SUPER_MAGIC),
 #define XLAT_VAL_86 ((unsigned) (FUSE_CTL_SUPER_MAGIC))
 #define XLAT_STR_86 STRINGIFY(FUSE_CTL_SUPER_MAGIC)
 XLAT(FUSE_SUPER_MAGIC),
 #define XLAT_VAL_87 ((unsigned) (FUSE_SUPER_MAGIC))
 #define XLAT_STR_87 STRINGIFY(FUSE_SUPER_MAGIC)
 XLAT(QNX6_SUPER_MAGIC),
 #define XLAT_VAL_88 ((unsigned) (QNX6_SUPER_MAGIC))
 #define XLAT_STR_88 STRINGIFY(QNX6_SUPER_MAGIC)
 XLAT(AFS_FS_MAGIC),
 #define XLAT_VAL_89 ((unsigned) (AFS_FS_MAGIC))
 #define XLAT_STR_89 STRINGIFY(AFS_FS_MAGIC)
 XLAT(BINDERFS_SUPER_MAGIC),
 #define XLAT_VAL_90 ((unsigned) (BINDERFS_SUPER_MAGIC))
 #define XLAT_STR_90 STRINGIFY(BINDERFS_SUPER_MAGIC)
 XLAT(NSFS_MAGIC),
 #define XLAT_VAL_91 ((unsigned) (NSFS_MAGIC))
 #define XLAT_STR_91 STRINGIFY(NSFS_MAGIC)
 XLAT(SECURITYFS_MAGIC),
 #define XLAT_VAL_92 ((unsigned) (SECURITYFS_MAGIC))
 #define XLAT_STR_92 STRINGIFY(SECURITYFS_MAGIC)
 XLAT(SQUASHFS_MAGIC),
 #define XLAT_VAL_93 ((unsigned) (SQUASHFS_MAGIC))
 #define XLAT_STR_93 STRINGIFY(SQUASHFS_MAGIC)
 XLAT(BTRFS_TEST_MAGIC),
 #define XLAT_VAL_94 ((unsigned) (BTRFS_TEST_MAGIC))
 #define XLAT_STR_94 STRINGIFY(BTRFS_TEST_MAGIC)
 XLAT(CODA_SUPER_MAGIC),
 #define XLAT_VAL_95 ((unsigned) (CODA_SUPER_MAGIC))
 #define XLAT_STR_95 STRINGIFY(CODA_SUPER_MAGIC)
 XLAT(OCFS2_SUPER_MAGIC),
 #define XLAT_VAL_96 ((unsigned) (OCFS2_SUPER_MAGIC))
 #define XLAT_STR_96 STRINGIFY(OCFS2_SUPER_MAGIC)
 XLAT(TRACEFS_MAGIC),
 #define XLAT_VAL_97 ((unsigned) (TRACEFS_MAGIC))
 #define XLAT_STR_97 STRINGIFY(TRACEFS_MAGIC)
 XLAT(OVERLAYFS_SUPER_MAGIC),
 #define XLAT_VAL_98 ((unsigned) (OVERLAYFS_SUPER_MAGIC))
 #define XLAT_STR_98 STRINGIFY(OVERLAYFS_SUPER_MAGIC)
 XLAT(RAMFS_MAGIC),
 #define XLAT_VAL_99 ((unsigned) (RAMFS_MAGIC))
 #define XLAT_STR_99 STRINGIFY(RAMFS_MAGIC)
 XLAT(BTRFS_SUPER_MAGIC),
 #define XLAT_VAL_100 ((unsigned) (BTRFS_SUPER_MAGIC))
 #define XLAT_STR_100 STRINGIFY(BTRFS_SUPER_MAGIC)
 XLAT(HUGETLBFS_MAGIC),
 #define XLAT_VAL_101 ((unsigned) (HUGETLBFS_MAGIC))
 #define XLAT_STR_101 STRINGIFY(HUGETLBFS_MAGIC)
 XLAT(VXFS_SUPER_MAGIC),
 #define XLAT_VAL_102 ((unsigned) (VXFS_SUPER_MAGIC))
 #define XLAT_STR_102 STRINGIFY(VXFS_SUPER_MAGIC)
 XLAT(XENFS_SUPER_MAGIC),
 #define XLAT_VAL_103 ((unsigned) (XENFS_SUPER_MAGIC))
 #define XLAT_STR_103 STRINGIFY(XENFS_SUPER_MAGIC)
 XLAT(PPC_CMM_MAGIC),
 #define XLAT_VAL_104 ((unsigned) (PPC_CMM_MAGIC))
 #define XLAT_STR_104 STRINGIFY(PPC_CMM_MAGIC)
 XLAT(LOGFS_MAGIC),
