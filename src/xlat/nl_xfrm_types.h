...
#endif
#if defined(XFRM_MSG_MIGRATE_STATE) || (defined(HAVE_DECL_XFRM_MSG_MIGRATE_STATE) && HAVE_DECL_XFRM_MSG_MIGRATE_STATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((XFRM_MSG_MIGRATE_STATE) == (0x29), "XFRM_MSG_MIGRATE_STATE != 0x29");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define XFRM_MSG_MIGRATE_STATE 0x29
#endif
#if defined(XFRM_MSG_MIGRATE_STATE) || (defined(HAVE_DECL_XFRM_MSG_MIGRATE_STATE) && HAVE_DECL_XFRM_MSG_MIGRATE_STATE)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (XFRM_MSG_MIGRATE_STATE)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: XFRM_MSG_MIGRATE_STATE"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (XFRM_MSG_MIGRATE_STATE)
#endif
#undef XLAT_PREV_VAL
...
static const struct xlat_data nl_xfrm_types_xdata[] = {
 ...
 XLAT(XFRM_MSG_MIGRATE_STATE),
 #define XLAT_VAL_25 ((unsigned) (XFRM_MSG_MIGRATE_STATE))
 #define XLAT_STR_25 STRINGIFY(XFRM_MSG_MIGRATE_STATE)
};
static
