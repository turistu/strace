...
static const struct xlat_data rtnl_nexthop_attrs_xdata[] = {
 ...
 [NHA_OP_FLAGS] = XLAT(NHA_OP_FLAGS),
 #define XLAT_VAL_14 ((unsigned) (NHA_OP_FLAGS))
 #define XLAT_STR_14 STRINGIFY(NHA_OP_FLAGS)
 [NHA_GROUP_STATS] = XLAT(NHA_GROUP_STATS),
 #define XLAT_VAL_15 ((unsigned) (NHA_GROUP_STATS))
 #define XLAT_STR_15 STRINGIFY(NHA_GROUP_STATS)
 [NHA_HW_STATS_ENABLE] = XLAT(NHA_HW_STATS_ENABLE),
 #define XLAT_VAL_16 ((unsigned) (NHA_HW_STATS_ENABLE))
 #define XLAT_STR_16 STRINGIFY(NHA_HW_STATS_ENABLE)
 [NHA_HW_STATS_USED] = XLAT(NHA_HW_STATS_USED),
 #define XLAT_VAL_17 ((unsigned) (NHA_HW_STATS_USED))
 #define XLAT_STR_17 STRINGIFY(NHA_HW_STATS_USED)
 [NHA_DST_PORT] = XLAT(NHA_DST_PORT),
 #define XLAT_VAL_18 ((unsigned) (NHA_DST_PORT))
 #define XLAT_STR_18 STRINGIFY(NHA_DST_PORT)
};
static
