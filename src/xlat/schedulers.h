...
static_assert((SCHED_OTHER) == (0), "SCHED_OTHER != 0");
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_FIFO) == (1), "SCHED_FIFO != 1");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define SCHED_FIFO 1
#endif
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_RR) == (2), "SCHED_RR != 2");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define SCHED_RR 2
#endif
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_BATCH) == (3), "SCHED_BATCH != 3");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_ISO) == (4), "SCHED_ISO != 4");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define SCHED_ISO 4
#endif
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_IDLE) == (5), "SCHED_IDLE != 5");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define SCHED_IDLE 5
#endif
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_DEADLINE) == (6), "SCHED_DEADLINE != 6");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((SCHED_EXT) == (7), "SCHED_EXT != 7");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define SCHED_EXT 7
#endif
