...
static const struct xlat_data uring_enter_flags_xdata[] = {
 ...
 #define XLAT_VAL_6 ((unsigned) (IORING_ENTER_EXT_ARG_REG))
 #define XLAT_STR_6 STRINGIFY(IORING_ENTER_EXT_ARG_REG)
 XLAT(IORING_ENTER_NO_IOWAIT),
 #define XLAT_VAL_7 ((unsigned) (IORING_ENTER_NO_IOWAIT))
 #define XLAT_STR_7 STRINGIFY(IORING_ENTER_NO_IOWAIT)
};
static
