...
static const struct xlat_data uring_setup_features_xdata[] = {
 ...
 XLAT(IORING_FEAT_RW_ATTR),
 #define XLAT_VAL_16 ((unsigned) (IORING_FEAT_RW_ATTR))
 #define XLAT_STR_16 STRINGIFY(IORING_FEAT_RW_ATTR)
 XLAT(IORING_FEAT_NO_IOWAIT),
 #define XLAT_VAL_17 ((unsigned) (IORING_FEAT_NO_IOWAIT))
 #define XLAT_STR_17 STRINGIFY(IORING_FEAT_NO_IOWAIT)
};
static
