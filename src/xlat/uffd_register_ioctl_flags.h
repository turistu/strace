...
static const struct xlat_data uffd_register_ioctl_flags_xdata[] = {
 ...
 XLAT_TYPE_PAIR(uint64_t, 1ULL<<_UFFDIO_RWPROTECT, "1<<_UFFDIO_RWPROTECT"),
 #define XLAT_VAL_7 ((uint64_t) (1ULL<<_UFFDIO_RWPROTECT))
 #define XLAT_STR_7 "1<<_UFFDIO_RWPROTECT"
};
static
