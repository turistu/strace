...
#endif
#if defined(DEVCONF_FORCE_FORWARDING) || (defined(HAVE_DECL_DEVCONF_FORCE_FORWARDING) && HAVE_DECL_DEVCONF_FORCE_FORWARDING)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((DEVCONF_FORCE_FORWARDING) == (59), "DEVCONF_FORCE_FORWARDING != 59");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define DEVCONF_FORCE_FORWARDING 59
#endif
#undef XLAT_PREV_VAL
...
static const struct xlat_data inet6_devconf_indices_xdata[] = {
 ...
 [DEVCONF_FORCE_FORWARDING] = XLAT(DEVCONF_FORCE_FORWARDING),
 #define XLAT_VAL_59 ((unsigned) (DEVCONF_FORCE_FORWARDING))
 #define XLAT_STR_59 STRINGIFY(DEVCONF_FORCE_FORWARDING)
};
static
