...
# define KT_BRL 14
#endif
#if defined(KT_CSI) || (defined(HAVE_DECL_KT_CSI) && HAVE_DECL_KT_CSI)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((KT_CSI) == (15), "KT_CSI != 15");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define KT_CSI 15
#endif
...
static const struct xlat_data kd_key_types_xdata[] = {
 ...
 [KT_CSI] = XLAT(KT_CSI),
 #define XLAT_VAL_15 ((unsigned) (KT_CSI))
 #define XLAT_STR_15 STRINGIFY(KT_CSI)
};
static
