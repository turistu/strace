...
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((RTEXT_FILTER_MST) == ((1 << 7)), "RTEXT_FILTER_MST != (1 << 7)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((RTEXT_FILTER_NAME_ONLY) == ((1 << 8)), "RTEXT_FILTER_NAME_ONLY != (1 << 8)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#undef XLAT_PREV_VAL
...
static const struct xlat_data rtnl_ifla_ext_filter_flags_xdata[] = {
 ...
 XLAT(RTEXT_FILTER_MST),
 #define XLAT_VAL_7 ((unsigned) (RTEXT_FILTER_MST))
 #define XLAT_STR_7 STRINGIFY(RTEXT_FILTER_MST)
 XLAT(RTEXT_FILTER_NAME_ONLY),
 #define XLAT_VAL_8 ((unsigned) (RTEXT_FILTER_NAME_ONLY))
 #define XLAT_STR_8 STRINGIFY(RTEXT_FILTER_NAME_ONLY)
};
static
