...
static const struct xlat_data uring_register_opcodes_xdata[] = {
 ...
 [IORING_REGISTER_SEND_MSG_RING] = XLAT(IORING_REGISTER_SEND_MSG_RING),
 #define XLAT_VAL_31 ((unsigned) (IORING_REGISTER_SEND_MSG_RING))
 #define XLAT_STR_31 STRINGIFY(IORING_REGISTER_SEND_MSG_RING)
 [IORING_REGISTER_ZCRX_IFQ] = XLAT(IORING_REGISTER_ZCRX_IFQ),
 #define XLAT_VAL_32 ((unsigned) (IORING_REGISTER_ZCRX_IFQ))
 #define XLAT_STR_32 STRINGIFY(IORING_REGISTER_ZCRX_IFQ)
 [IORING_REGISTER_RESIZE_RINGS] = XLAT(IORING_REGISTER_RESIZE_RINGS),
 #define XLAT_VAL_33 ((unsigned) (IORING_REGISTER_RESIZE_RINGS))
 #define XLAT_STR_33 STRINGIFY(IORING_REGISTER_RESIZE_RINGS)
 [IORING_REGISTER_MEM_REGION] = XLAT(IORING_REGISTER_MEM_REGION),
 #define XLAT_VAL_34 ((unsigned) (IORING_REGISTER_MEM_REGION))
 #define XLAT_STR_34 STRINGIFY(IORING_REGISTER_MEM_REGION)
 [IORING_REGISTER_QUERY] = XLAT(IORING_REGISTER_QUERY),
 #define XLAT_VAL_35 ((unsigned) (IORING_REGISTER_QUERY))
 #define XLAT_STR_35 STRINGIFY(IORING_REGISTER_QUERY)
 [IORING_REGISTER_ZCRX_CTRL] = XLAT(IORING_REGISTER_ZCRX_CTRL),
 #define XLAT_VAL_36 ((unsigned) (IORING_REGISTER_ZCRX_CTRL))
 #define XLAT_STR_36 STRINGIFY(IORING_REGISTER_ZCRX_CTRL)
 [IORING_REGISTER_BPF_FILTER] = XLAT(IORING_REGISTER_BPF_FILTER),
 #define XLAT_VAL_37 ((unsigned) (IORING_REGISTER_BPF_FILTER))
 #define XLAT_STR_37 STRINGIFY(IORING_REGISTER_BPF_FILTER)
};
static
