...
static const struct xlat_data rtnl_ifla_brport_attrs_xdata[] = {
 ...
 [IFLA_BRPORT_NEIGH_FORWARD_GRAT] = XLAT(IFLA_BRPORT_NEIGH_FORWARD_GRAT),
 #define XLAT_VAL_45 ((unsigned) (IFLA_BRPORT_NEIGH_FORWARD_GRAT))
 #define XLAT_STR_45 STRINGIFY(IFLA_BRPORT_NEIGH_FORWARD_GRAT)
};
static
