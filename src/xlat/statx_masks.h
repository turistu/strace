...
#endif
#if defined(STATX_DIO_READ_ALIGN) || (defined(HAVE_DECL_STATX_DIO_READ_ALIGN) && HAVE_DECL_STATX_DIO_READ_ALIGN)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((STATX_DIO_READ_ALIGN) == (0x00020000U), "STATX_DIO_READ_ALIGN != 0x00020000U");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data statx_masks_xdata[] = {
 ...
 #define XLAT_VAL_19 ((unsigned) (STATX_DIO_READ_ALIGN))
 #define XLAT_STR_19 STRINGIFY(STATX_DIO_READ_ALIGN)
};
static
