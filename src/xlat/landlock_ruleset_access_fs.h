...
static const struct xlat_data landlock_ruleset_access_fs_xdata[] = {
 ...
 XLAT(LANDLOCK_ACCESS_FS_RESOLVE_UNIX),
 #define XLAT_VAL_16 ((unsigned) (LANDLOCK_ACCESS_FS_RESOLVE_UNIX))
 #define XLAT_STR_16 STRINGIFY(LANDLOCK_ACCESS_FS_RESOLVE_UNIX)
};
static
