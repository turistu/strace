...
#endif
#if defined(PERF_ATTR_SIZE_VER8) || (defined(HAVE_DECL_PERF_ATTR_SIZE_VER8) && HAVE_DECL_PERF_ATTR_SIZE_VER8)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((PERF_ATTR_SIZE_VER8) == (136), "PERF_ATTR_SIZE_VER8 != 136");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define PERF_ATTR_SIZE_VER8 136
#endif
#if defined(PERF_ATTR_SIZE_VER9) || (defined(HAVE_DECL_PERF_ATTR_SIZE_VER9) && HAVE_DECL_PERF_ATTR_SIZE_VER9)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((PERF_ATTR_SIZE_VER9) == (144), "PERF_ATTR_SIZE_VER9 != 144");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data perf_attr_size_xdata[] = {
 ...
 #define XLAT_VAL_8 ((unsigned) (PERF_ATTR_SIZE_VER8))
 #define XLAT_STR_8 STRINGIFY(PERF_ATTR_SIZE_VER8)
 XLAT(PERF_ATTR_SIZE_VER9),
 #define XLAT_VAL_9 ((unsigned) (PERF_ATTR_SIZE_VER9))
 #define XLAT_STR_9 STRINGIFY(PERF_ATTR_SIZE_VER9)
};
static
