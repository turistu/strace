...
static const struct xlat_data genl_ethtool_msg_recv_xdata[] = {
 ...
 [ETHTOOL_MSG_PHY_GET_REPLY] = XLAT(ETHTOOL_MSG_PHY_GET_REPLY),
 #define XLAT_VAL_45 ((unsigned) (ETHTOOL_MSG_PHY_GET_REPLY))
 #define XLAT_STR_45 STRINGIFY(ETHTOOL_MSG_PHY_GET_REPLY)
 [ETHTOOL_MSG_PHY_NTF] = XLAT(ETHTOOL_MSG_PHY_NTF),
 #define XLAT_VAL_46 ((unsigned) (ETHTOOL_MSG_PHY_NTF))
 #define XLAT_STR_46 STRINGIFY(ETHTOOL_MSG_PHY_NTF)
 [ETHTOOL_MSG_TSCONFIG_GET_REPLY] = XLAT(ETHTOOL_MSG_TSCONFIG_GET_REPLY),
 #define XLAT_VAL_47 ((unsigned) (ETHTOOL_MSG_TSCONFIG_GET_REPLY))
 #define XLAT_STR_47 STRINGIFY(ETHTOOL_MSG_TSCONFIG_GET_REPLY)
 [ETHTOOL_MSG_TSCONFIG_SET_REPLY] = XLAT(ETHTOOL_MSG_TSCONFIG_SET_REPLY),
 #define XLAT_VAL_48 ((unsigned) (ETHTOOL_MSG_TSCONFIG_SET_REPLY))
 #define XLAT_STR_48 STRINGIFY(ETHTOOL_MSG_TSCONFIG_SET_REPLY)
 [ETHTOOL_MSG_PSE_NTF] = XLAT(ETHTOOL_MSG_PSE_NTF),
 #define XLAT_VAL_49 ((unsigned) (ETHTOOL_MSG_PSE_NTF))
 #define XLAT_STR_49 STRINGIFY(ETHTOOL_MSG_PSE_NTF)
 [ETHTOOL_MSG_RSS_NTF] = XLAT(ETHTOOL_MSG_RSS_NTF),
 #define XLAT_VAL_50 ((unsigned) (ETHTOOL_MSG_RSS_NTF))
 #define XLAT_STR_50 STRINGIFY(ETHTOOL_MSG_RSS_NTF)
 [ETHTOOL_MSG_RSS_CREATE_ACT_REPLY] = XLAT(ETHTOOL_MSG_RSS_CREATE_ACT_REPLY),
 #define XLAT_VAL_51 ((unsigned) (ETHTOOL_MSG_RSS_CREATE_ACT_REPLY))
 #define XLAT_STR_51 STRINGIFY(ETHTOOL_MSG_RSS_CREATE_ACT_REPLY)
 [ETHTOOL_MSG_RSS_CREATE_NTF] = XLAT(ETHTOOL_MSG_RSS_CREATE_NTF),
 #define XLAT_VAL_52 ((unsigned) (ETHTOOL_MSG_RSS_CREATE_NTF))
 #define XLAT_STR_52 STRINGIFY(ETHTOOL_MSG_RSS_CREATE_NTF)
 [ETHTOOL_MSG_RSS_DELETE_NTF] = XLAT(ETHTOOL_MSG_RSS_DELETE_NTF),
 #define XLAT_VAL_53 ((unsigned) (ETHTOOL_MSG_RSS_DELETE_NTF))
 #define XLAT_STR_53 STRINGIFY(ETHTOOL_MSG_RSS_DELETE_NTF)
 [ETHTOOL_MSG_MSE_GET_REPLY] = XLAT(ETHTOOL_MSG_MSE_GET_REPLY),
 #define XLAT_VAL_54 ((unsigned) (ETHTOOL_MSG_MSE_GET_REPLY))
 #define XLAT_STR_54 STRINGIFY(ETHTOOL_MSG_MSE_GET_REPLY)
};
static
