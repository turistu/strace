...
static const struct xlat_data uffd_api_features_xdata[] = {
 ...
 XLAT_TYPE(uint64_t, UFFD_FEATURE_RWP),
 #define XLAT_VAL_17 ((uint64_t) (UFFD_FEATURE_RWP))
 #define XLAT_STR_17 STRINGIFY(UFFD_FEATURE_RWP)
 XLAT_TYPE(uint64_t, UFFD_FEATURE_RWP_ASYNC),
 #define XLAT_VAL_18 ((uint64_t) (UFFD_FEATURE_RWP_ASYNC))
 #define XLAT_STR_18 STRINGIFY(UFFD_FEATURE_RWP_ASYNC)
};
static
