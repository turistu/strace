...
#endif
#if defined(ATA_CMD_GET_PHYS_ELEMENT_STATUS) || (defined(HAVE_DECL_ATA_CMD_GET_PHYS_ELEMENT_STATUS) && HAVE_DECL_ATA_CMD_GET_PHYS_ELEMENT_STATUS)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((ATA_CMD_GET_PHYS_ELEMENT_STATUS) == (0x12), "ATA_CMD_GET_PHYS_ELEMENT_STATUS != 0x12");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define ATA_CMD_GET_PHYS_ELEMENT_STATUS 0x12
#endif
#if defined(ATA_CMD_GET_PHYS_ELEMENT_STATUS) || (defined(HAVE_DECL_ATA_CMD_GET_PHYS_ELEMENT_STATUS) && HAVE_DECL_ATA_CMD_GET_PHYS_ELEMENT_STATUS)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (ATA_CMD_GET_PHYS_ELEMENT_STATUS)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: ATA_CMD_GET_PHYS_ELEMENT_STATUS"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (ATA_CMD_GET_PHYS_ELEMENT_STATUS)
#endif
...
#endif
#if defined(ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE) || (defined(HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE) && HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE) == (0x7c), "ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE != 0x7c");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE 0x7c
#endif
#if defined(ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE) || (defined(HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE) && HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE)
#endif
#if defined(ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD) || (defined(HAVE_DECL_ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD) && HAVE_DECL_ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD) == (0x7d), "ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD != 0x7d");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD 0x7d
#endif
#if defined(ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD) || (defined(HAVE_DECL_ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD) && HAVE_DECL_ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD)
#endif
#if defined(ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES) || (defined(HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES) && HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES) == (0x7e), "ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES != 0x7e");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES 0x7e
#endif
#if defined(ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES) || (defined(HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES) && HAVE_DECL_ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES)
#endif
...
static const struct xlat_data hdio_drive_cmds_xdata[] = {
 ...
 XLAT(ATA_CMD_GET_PHYS_ELEMENT_STATUS),
 #define XLAT_VAL_6 ((unsigned) (ATA_CMD_GET_PHYS_ELEMENT_STATUS))
 #define XLAT_STR_6 STRINGIFY(ATA_CMD_GET_PHYS_ELEMENT_STATUS)
 XLAT(ATA_CMD_PIO_READ),
 #define XLAT_VAL_7 ((unsigned) (ATA_CMD_PIO_READ))
 #define XLAT_STR_7 STRINGIFY(ATA_CMD_PIO_READ)
 XLAT(ATA_CMD_READ_LONG),
 #define XLAT_VAL_8 ((unsigned) (ATA_CMD_READ_LONG))
 #define XLAT_STR_8 STRINGIFY(ATA_CMD_READ_LONG)
 XLAT(ATA_CMD_READ_LONG_ONCE),
 #define XLAT_VAL_9 ((unsigned) (ATA_CMD_READ_LONG_ONCE))
 #define XLAT_STR_9 STRINGIFY(ATA_CMD_READ_LONG_ONCE)
 XLAT(ATA_CMD_PIO_READ_EXT),
 #define XLAT_VAL_10 ((unsigned) (ATA_CMD_PIO_READ_EXT))
 #define XLAT_STR_10 STRINGIFY(ATA_CMD_PIO_READ_EXT)
 XLAT(ATA_CMD_READ_EXT),
 #define XLAT_VAL_11 ((unsigned) (ATA_CMD_READ_EXT))
 #define XLAT_STR_11 STRINGIFY(ATA_CMD_READ_EXT)
 XLAT(ATA_CMD_READ_QUEUED),
 #define XLAT_VAL_12 ((unsigned) (ATA_CMD_READ_QUEUED))
 #define XLAT_STR_12 STRINGIFY(ATA_CMD_READ_QUEUED)
 XLAT(ATA_CMD_READ_NATIVE_MAX_EXT),
 #define XLAT_VAL_13 ((unsigned) (ATA_CMD_READ_NATIVE_MAX_EXT))
 #define XLAT_STR_13 STRINGIFY(ATA_CMD_READ_NATIVE_MAX_EXT)
 XLAT(ATA_CMD_READ_MULTI_EXT),
 #define XLAT_VAL_14 ((unsigned) (ATA_CMD_READ_MULTI_EXT))
 #define XLAT_STR_14 STRINGIFY(ATA_CMD_READ_MULTI_EXT)
 XLAT(ATA_CMD_READ_STREAM_DMA_EXT),
 #define XLAT_VAL_15 ((unsigned) (ATA_CMD_READ_STREAM_DMA_EXT))
 #define XLAT_STR_15 STRINGIFY(ATA_CMD_READ_STREAM_DMA_EXT)
 XLAT(ATA_CMD_READ_STREAM_EXT),
 #define XLAT_VAL_16 ((unsigned) (ATA_CMD_READ_STREAM_EXT))
 #define XLAT_STR_16 STRINGIFY(ATA_CMD_READ_STREAM_EXT)
 XLAT(ATA_CMD_READ_LOG_EXT),
 #define XLAT_VAL_17 ((unsigned) (ATA_CMD_READ_LOG_EXT))
 #define XLAT_STR_17 STRINGIFY(ATA_CMD_READ_LOG_EXT)
 XLAT(ATA_CMD_PIO_WRITE),
 #define XLAT_VAL_18 ((unsigned) (ATA_CMD_PIO_WRITE))
 #define XLAT_STR_18 STRINGIFY(ATA_CMD_PIO_WRITE)
 XLAT(ATA_CMD_WRITE_LONG),
 #define XLAT_VAL_19 ((unsigned) (ATA_CMD_WRITE_LONG))
 #define XLAT_STR_19 STRINGIFY(ATA_CMD_WRITE_LONG)
 XLAT(ATA_CMD_WRITE_LONG_ONCE),
 #define XLAT_VAL_20 ((unsigned) (ATA_CMD_WRITE_LONG_ONCE))
 #define XLAT_STR_20 STRINGIFY(ATA_CMD_WRITE_LONG_ONCE)
 XLAT(ATA_CMD_PIO_WRITE_EXT),
 #define XLAT_VAL_21 ((unsigned) (ATA_CMD_PIO_WRITE_EXT))
 #define XLAT_STR_21 STRINGIFY(ATA_CMD_PIO_WRITE_EXT)
 XLAT(ATA_CMD_WRITE_EXT),
 #define XLAT_VAL_22 ((unsigned) (ATA_CMD_WRITE_EXT))
 #define XLAT_STR_22 STRINGIFY(ATA_CMD_WRITE_EXT)
 XLAT(ATA_CMD_WRITE_QUEUED),
 #define XLAT_VAL_23 ((unsigned) (ATA_CMD_WRITE_QUEUED))
 #define XLAT_STR_23 STRINGIFY(ATA_CMD_WRITE_QUEUED)
 XLAT(ATA_CMD_SET_MAX_EXT),
 #define XLAT_VAL_24 ((unsigned) (ATA_CMD_SET_MAX_EXT))
 #define XLAT_STR_24 STRINGIFY(ATA_CMD_SET_MAX_EXT)
 XLAT(ATA_CMD_CFA_WRITE_NE),
 #define XLAT_VAL_25 ((unsigned) (ATA_CMD_CFA_WRITE_NE))
 #define XLAT_STR_25 STRINGIFY(ATA_CMD_CFA_WRITE_NE)
 XLAT(ATA_CMD_WRITE_MULTI_EXT),
 #define XLAT_VAL_26 ((unsigned) (ATA_CMD_WRITE_MULTI_EXT))
 #define XLAT_STR_26 STRINGIFY(ATA_CMD_WRITE_MULTI_EXT)
 XLAT(ATA_CMD_WRITE_STREAM_DMA_EXT),
 #define XLAT_VAL_27 ((unsigned) (ATA_CMD_WRITE_STREAM_DMA_EXT))
 #define XLAT_STR_27 STRINGIFY(ATA_CMD_WRITE_STREAM_DMA_EXT)
 XLAT(ATA_CMD_WRITE_STREAM_EXT),
 #define XLAT_VAL_28 ((unsigned) (ATA_CMD_WRITE_STREAM_EXT))
 #define XLAT_STR_28 STRINGIFY(ATA_CMD_WRITE_STREAM_EXT)
 XLAT(ATA_CMD_WRITE_FUA_EXT),
 #define XLAT_VAL_29 ((unsigned) (ATA_CMD_WRITE_FUA_EXT))
 #define XLAT_STR_29 STRINGIFY(ATA_CMD_WRITE_FUA_EXT)
 XLAT(ATA_CMD_WRITE_QUEUED_FUA_EXT),
 #define XLAT_VAL_30 ((unsigned) (ATA_CMD_WRITE_QUEUED_FUA_EXT))
 #define XLAT_STR_30 STRINGIFY(ATA_CMD_WRITE_QUEUED_FUA_EXT)
 XLAT(ATA_CMD_WRITE_LOG_EXT),
 #define XLAT_VAL_31 ((unsigned) (ATA_CMD_WRITE_LOG_EXT))
 #define XLAT_STR_31 STRINGIFY(ATA_CMD_WRITE_LOG_EXT)
 XLAT(ATA_CMD_VERIFY),
 #define XLAT_VAL_32 ((unsigned) (ATA_CMD_VERIFY))
 #define XLAT_STR_32 STRINGIFY(ATA_CMD_VERIFY)
 XLAT(ATA_CMD_VERIFY_EXT),
 #define XLAT_VAL_33 ((unsigned) (ATA_CMD_VERIFY_EXT))
 #define XLAT_STR_33 STRINGIFY(ATA_CMD_VERIFY_EXT)
 XLAT(ATA_CMD_WRITE_UNCORR_EXT),
 #define XLAT_VAL_34 ((unsigned) (ATA_CMD_WRITE_UNCORR_EXT))
 #define XLAT_STR_34 STRINGIFY(ATA_CMD_WRITE_UNCORR_EXT)
 XLAT(ATA_CMD_READ_LOG_DMA_EXT),
 #define XLAT_VAL_35 ((unsigned) (ATA_CMD_READ_LOG_DMA_EXT))
 #define XLAT_STR_35 STRINGIFY(ATA_CMD_READ_LOG_DMA_EXT)
 XLAT(ATA_CMD_ZAC_MGMT_IN),
 #define XLAT_VAL_36 ((unsigned) (ATA_CMD_ZAC_MGMT_IN))
 #define XLAT_STR_36 STRINGIFY(ATA_CMD_ZAC_MGMT_IN)
 XLAT(ATA_CMD_CONFIG_STREAM),
 #define XLAT_VAL_37 ((unsigned) (ATA_CMD_CONFIG_STREAM))
 #define XLAT_STR_37 STRINGIFY(ATA_CMD_CONFIG_STREAM)
 XLAT(ATA_CMD_WRITE_LOG_DMA_EXT),
 #define XLAT_VAL_38 ((unsigned) (ATA_CMD_WRITE_LOG_DMA_EXT))
 #define XLAT_STR_38 STRINGIFY(ATA_CMD_WRITE_LOG_DMA_EXT)
 XLAT(ATA_CMD_TRUSTED_NONDATA),
 #define XLAT_VAL_39 ((unsigned) (ATA_CMD_TRUSTED_NONDATA))
 #define XLAT_STR_39 STRINGIFY(ATA_CMD_TRUSTED_NONDATA)
 XLAT(ATA_CMD_TRUSTED_RCV),
 #define XLAT_VAL_40 ((unsigned) (ATA_CMD_TRUSTED_RCV))
 #define XLAT_STR_40 STRINGIFY(ATA_CMD_TRUSTED_RCV)
 XLAT(ATA_CMD_TRUSTED_RCV_DMA),
 #define XLAT_VAL_41 ((unsigned) (ATA_CMD_TRUSTED_RCV_DMA))
 #define XLAT_STR_41 STRINGIFY(ATA_CMD_TRUSTED_RCV_DMA)
 XLAT(ATA_CMD_TRUSTED_SND),
 #define XLAT_VAL_42 ((unsigned) (ATA_CMD_TRUSTED_SND))
 #define XLAT_STR_42 STRINGIFY(ATA_CMD_TRUSTED_SND)
 XLAT(ATA_CMD_TRUSTED_SND_DMA),
 #define XLAT_VAL_43 ((unsigned) (ATA_CMD_TRUSTED_SND_DMA))
 #define XLAT_STR_43 STRINGIFY(ATA_CMD_TRUSTED_SND_DMA)
 XLAT(ATA_CMD_FPDMA_READ),
 #define XLAT_VAL_44 ((unsigned) (ATA_CMD_FPDMA_READ))
 #define XLAT_STR_44 STRINGIFY(ATA_CMD_FPDMA_READ)
 XLAT(ATA_CMD_FPDMA_WRITE),
 #define XLAT_VAL_45 ((unsigned) (ATA_CMD_FPDMA_WRITE))
 #define XLAT_STR_45 STRINGIFY(ATA_CMD_FPDMA_WRITE)
 XLAT(ATA_CMD_NCQ_NON_DATA),
 #define XLAT_VAL_46 ((unsigned) (ATA_CMD_NCQ_NON_DATA))
 #define XLAT_STR_46 STRINGIFY(ATA_CMD_NCQ_NON_DATA)
 XLAT(ATA_CMD_FPDMA_SEND),
 #define XLAT_VAL_47 ((unsigned) (ATA_CMD_FPDMA_SEND))
 #define XLAT_STR_47 STRINGIFY(ATA_CMD_FPDMA_SEND)
 XLAT(ATA_CMD_FPDMA_RECV),
 #define XLAT_VAL_48 ((unsigned) (ATA_CMD_FPDMA_RECV))
 #define XLAT_STR_48 STRINGIFY(ATA_CMD_FPDMA_RECV)
 XLAT(ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE),
 #define XLAT_VAL_49 ((unsigned) (ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE))
 #define XLAT_STR_49 STRINGIFY(ATA_CMD_REMOVE_ELEMENT_AND_TRUNCATE)
 XLAT(ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD),
 #define XLAT_VAL_50 ((unsigned) (ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD))
 #define XLAT_STR_50 STRINGIFY(ATA_CMD_RESTORE_ELEMENTS_AND_REBUILD)
 XLAT(ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES),
 #define XLAT_VAL_51 ((unsigned) (ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES))
 #define XLAT_STR_51 STRINGIFY(ATA_CMD_REMOVE_ELEMENT_AND_MODIFY_ZONES)
 XLAT(ATA_CMD_CFA_TRANS_SECT),
 #define XLAT_VAL_52 ((unsigned) (ATA_CMD_CFA_TRANS_SECT))
 #define XLAT_STR_52 STRINGIFY(ATA_CMD_CFA_TRANS_SECT)
 XLAT(ATA_CMD_EDD),
 #define XLAT_VAL_53 ((unsigned) (ATA_CMD_EDD))
 #define XLAT_STR_53 STRINGIFY(ATA_CMD_EDD)
 XLAT(ATA_CMD_INIT_DEV_PARAMS),
 #define XLAT_VAL_54 ((unsigned) (ATA_CMD_INIT_DEV_PARAMS))
 #define XLAT_STR_54 STRINGIFY(ATA_CMD_INIT_DEV_PARAMS)
 XLAT(ATA_CMD_DOWNLOAD_MICRO),
 #define XLAT_VAL_55 ((unsigned) (ATA_CMD_DOWNLOAD_MICRO))
 #define XLAT_STR_55 STRINGIFY(ATA_CMD_DOWNLOAD_MICRO)
 XLAT(ATA_CMD_DOWNLOAD_MICRO_DMA),
 #define XLAT_VAL_56 ((unsigned) (ATA_CMD_DOWNLOAD_MICRO_DMA))
 #define XLAT_STR_56 STRINGIFY(ATA_CMD_DOWNLOAD_MICRO_DMA)
 XLAT(ATA_CMD_ZAC_MGMT_OUT),
 #define XLAT_VAL_57 ((unsigned) (ATA_CMD_ZAC_MGMT_OUT))
 #define XLAT_STR_57 STRINGIFY(ATA_CMD_ZAC_MGMT_OUT)
 XLAT(ATA_CMD_PACKET),
 #define XLAT_VAL_58 ((unsigned) (ATA_CMD_PACKET))
 #define XLAT_STR_58 STRINGIFY(ATA_CMD_PACKET)
 XLAT(ATA_CMD_ID_ATAPI),
 #define XLAT_VAL_59 ((unsigned) (ATA_CMD_ID_ATAPI))
 #define XLAT_STR_59 STRINGIFY(ATA_CMD_ID_ATAPI)
 XLAT(ATA_CMD_SERVICE),
 #define XLAT_VAL_60 ((unsigned) (ATA_CMD_SERVICE))
 #define XLAT_STR_60 STRINGIFY(ATA_CMD_SERVICE)
 XLAT(ATA_CMD_SMART),
 #define XLAT_VAL_61 ((unsigned) (ATA_CMD_SMART))
 #define XLAT_STR_61 STRINGIFY(ATA_CMD_SMART)
 XLAT(ATA_CMD_CONF_OVERLAY),
 #define XLAT_VAL_62 ((unsigned) (ATA_CMD_CONF_OVERLAY))
 #define XLAT_STR_62 STRINGIFY(ATA_CMD_CONF_OVERLAY)
 XLAT(ATA_CMD_SANITIZE_DEVICE),
 #define XLAT_VAL_63 ((unsigned) (ATA_CMD_SANITIZE_DEVICE))
 #define XLAT_STR_63 STRINGIFY(ATA_CMD_SANITIZE_DEVICE)
 XLAT(ATA_CMD_CFA_ERASE),
 #define XLAT_VAL_64 ((unsigned) (ATA_CMD_CFA_ERASE))
 #define XLAT_STR_64 STRINGIFY(ATA_CMD_CFA_ERASE)
 XLAT(ATA_CMD_READ_MULTI),
 #define XLAT_VAL_65 ((unsigned) (ATA_CMD_READ_MULTI))
 #define XLAT_STR_65 STRINGIFY(ATA_CMD_READ_MULTI)
 XLAT(ATA_CMD_WRITE_MULTI),
 #define XLAT_VAL_66 ((unsigned) (ATA_CMD_WRITE_MULTI))
 #define XLAT_STR_66 STRINGIFY(ATA_CMD_WRITE_MULTI)
 XLAT(ATA_CMD_SET_MULTI),
 #define XLAT_VAL_67 ((unsigned) (ATA_CMD_SET_MULTI))
 #define XLAT_STR_67 STRINGIFY(ATA_CMD_SET_MULTI)
 XLAT(ATA_CMD_READ),
 #define XLAT_VAL_68 ((unsigned) (ATA_CMD_READ))
 #define XLAT_STR_68 STRINGIFY(ATA_CMD_READ)
 XLAT(ATA_CMD_WRITE),
 #define XLAT_VAL_69 ((unsigned) (ATA_CMD_WRITE))
 #define XLAT_STR_69 STRINGIFY(ATA_CMD_WRITE)
 XLAT(ATA_CMD_CFA_WRITE_MULT_NE),
 #define XLAT_VAL_70 ((unsigned) (ATA_CMD_CFA_WRITE_MULT_NE))
 #define XLAT_STR_70 STRINGIFY(ATA_CMD_CFA_WRITE_MULT_NE)
 XLAT(ATA_CMD_WRITE_MULTI_FUA_EXT),
 #define XLAT_VAL_71 ((unsigned) (ATA_CMD_WRITE_MULTI_FUA_EXT))
 #define XLAT_STR_71 STRINGIFY(ATA_CMD_WRITE_MULTI_FUA_EXT)
 XLAT(ATA_CMD_CHK_MED_CRD_TYP),
 #define XLAT_VAL_72 ((unsigned) (ATA_CMD_CHK_MED_CRD_TYP))
 #define XLAT_STR_72 STRINGIFY(ATA_CMD_CHK_MED_CRD_TYP)
 XLAT(ATA_CMD_MEDIA_LOCK),
 #define XLAT_VAL_73 ((unsigned) (ATA_CMD_MEDIA_LOCK))
 #define XLAT_STR_73 STRINGIFY(ATA_CMD_MEDIA_LOCK)
 XLAT(ATA_CMD_MEDIA_UNLOCK),
 #define XLAT_VAL_74 ((unsigned) (ATA_CMD_MEDIA_UNLOCK))
 #define XLAT_STR_74 STRINGIFY(ATA_CMD_MEDIA_UNLOCK)
 XLAT(ATA_CMD_STANDBYNOW1),
 #define XLAT_VAL_75 ((unsigned) (ATA_CMD_STANDBYNOW1))
 #define XLAT_STR_75 STRINGIFY(ATA_CMD_STANDBYNOW1)
 XLAT(ATA_CMD_IDLEIMMEDIATE),
 #define XLAT_VAL_76 ((unsigned) (ATA_CMD_IDLEIMMEDIATE))
 #define XLAT_STR_76 STRINGIFY(ATA_CMD_IDLEIMMEDIATE)
 XLAT(ATA_CMD_STANDBY),
 #define XLAT_VAL_77 ((unsigned) (ATA_CMD_STANDBY))
 #define XLAT_STR_77 STRINGIFY(ATA_CMD_STANDBY)
 XLAT(ATA_CMD_IDLE),
 #define XLAT_VAL_78 ((unsigned) (ATA_CMD_IDLE))
 #define XLAT_STR_78 STRINGIFY(ATA_CMD_IDLE)
 XLAT(ATA_CMD_PMP_READ),
 #define XLAT_VAL_79 ((unsigned) (ATA_CMD_PMP_READ))
 #define XLAT_STR_79 STRINGIFY(ATA_CMD_PMP_READ)
 XLAT(ATA_CMD_CHK_POWER),
 #define XLAT_VAL_80 ((unsigned) (ATA_CMD_CHK_POWER))
 #define XLAT_STR_80 STRINGIFY(ATA_CMD_CHK_POWER)
 XLAT(ATA_CMD_SLEEP),
 #define XLAT_VAL_81 ((unsigned) (ATA_CMD_SLEEP))
 #define XLAT_STR_81 STRINGIFY(ATA_CMD_SLEEP)
 XLAT(ATA_CMD_FLUSH),
 #define XLAT_VAL_82 ((unsigned) (ATA_CMD_FLUSH))
 #define XLAT_STR_82 STRINGIFY(ATA_CMD_FLUSH)
 XLAT(ATA_CMD_PMP_WRITE),
 #define XLAT_VAL_83 ((unsigned) (ATA_CMD_PMP_WRITE))
 #define XLAT_STR_83 STRINGIFY(ATA_CMD_PMP_WRITE)
 XLAT(ATA_CMD_PMP_READ_DMA),
 #define XLAT_VAL_84 ((unsigned) (ATA_CMD_PMP_READ_DMA))
 #define XLAT_STR_84 STRINGIFY(ATA_CMD_PMP_READ_DMA)
 XLAT(ATA_CMD_FLUSH_EXT),
 #define XLAT_VAL_85 ((unsigned) (ATA_CMD_FLUSH_EXT))
 #define XLAT_STR_85 STRINGIFY(ATA_CMD_FLUSH_EXT)
 XLAT(ATA_CMD_PMP_WRITE_DMA),
 #define XLAT_VAL_86 ((unsigned) (ATA_CMD_PMP_WRITE_DMA))
 #define XLAT_STR_86 STRINGIFY(ATA_CMD_PMP_WRITE_DMA)
 XLAT(ATA_CMD_ID_ATA),
 #define XLAT_VAL_87 ((unsigned) (ATA_CMD_ID_ATA))
 #define XLAT_STR_87 STRINGIFY(ATA_CMD_ID_ATA)
 XLAT(ATA_CMD_SET_FEATURES),
 #define XLAT_VAL_88 ((unsigned) (ATA_CMD_SET_FEATURES))
 #define XLAT_STR_88 STRINGIFY(ATA_CMD_SET_FEATURES)
 XLAT(ATA_CMD_SEC_SET_PASS),
 #define XLAT_VAL_89 ((unsigned) (ATA_CMD_SEC_SET_PASS))
 #define XLAT_STR_89 STRINGIFY(ATA_CMD_SEC_SET_PASS)
 XLAT(ATA_CMD_SEC_UNLOCK),
 #define XLAT_VAL_90 ((unsigned) (ATA_CMD_SEC_UNLOCK))
 #define XLAT_STR_90 STRINGIFY(ATA_CMD_SEC_UNLOCK)
 XLAT(ATA_CMD_SEC_ERASE_PREP),
 #define XLAT_VAL_91 ((unsigned) (ATA_CMD_SEC_ERASE_PREP))
 #define XLAT_STR_91 STRINGIFY(ATA_CMD_SEC_ERASE_PREP)
 XLAT(ATA_CMD_SEC_ERASE_UNIT),
 #define XLAT_VAL_92 ((unsigned) (ATA_CMD_SEC_ERASE_UNIT))
 #define XLAT_STR_92 STRINGIFY(ATA_CMD_SEC_ERASE_UNIT)
 XLAT(ATA_CMD_SEC_FREEZE_LOCK),
 #define XLAT_VAL_93 ((unsigned) (ATA_CMD_SEC_FREEZE_LOCK))
 #define XLAT_STR_93 STRINGIFY(ATA_CMD_SEC_FREEZE_LOCK)
 XLAT(ATA_CMD_SEC_DISABLE_PASS),
 #define XLAT_VAL_94 ((unsigned) (ATA_CMD_SEC_DISABLE_PASS))
 #define XLAT_STR_94 STRINGIFY(ATA_CMD_SEC_DISABLE_PASS)
 XLAT(ATA_CMD_READ_NATIVE_MAX),
 #define XLAT_VAL_95 ((unsigned) (ATA_CMD_READ_NATIVE_MAX))
 #define XLAT_STR_95 STRINGIFY(ATA_CMD_READ_NATIVE_MAX)
 XLAT(ATA_CMD_SET_MAX),
 #define XLAT_VAL_96 ((unsigned) (ATA_CMD_SET_MAX))
 #define XLAT_STR_96 STRINGIFY(ATA_CMD_SET_MAX)
};
