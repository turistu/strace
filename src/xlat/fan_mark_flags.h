...
#endif
#if defined(FAN_MARK_MNTNS) || (defined(HAVE_DECL_FAN_MARK_MNTNS) && HAVE_DECL_FAN_MARK_MNTNS)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FAN_MARK_MNTNS) == (0x00000110), "FAN_MARK_MNTNS != 0x00000110");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data fan_mark_flags_xdata[] = {
 ...
 XLAT(FAN_MARK_FLUSH),
 #define XLAT_VAL_2 ((unsigned) (FAN_MARK_FLUSH))
 #define XLAT_STR_2 STRINGIFY(FAN_MARK_FLUSH)

 XLAT(FAN_MARK_DONT_FOLLOW),
 #define XLAT_VAL_3 ((unsigned) (FAN_MARK_DONT_FOLLOW))
 #define XLAT_STR_3 STRINGIFY(FAN_MARK_DONT_FOLLOW)
 XLAT(FAN_MARK_ONLYDIR),
 #define XLAT_VAL_4 ((unsigned) (FAN_MARK_ONLYDIR))
 #define XLAT_STR_4 STRINGIFY(FAN_MARK_ONLYDIR)
 XLAT(FAN_MARK_MNTNS),
 #define XLAT_VAL_5 ((unsigned) (FAN_MARK_MNTNS))
 #define XLAT_STR_5 STRINGIFY(FAN_MARK_MNTNS)
 XLAT(FAN_MARK_MOUNT),
 #define XLAT_VAL_6 ((unsigned) (FAN_MARK_MOUNT))
 #define XLAT_STR_6 STRINGIFY(FAN_MARK_MOUNT)
 XLAT(FAN_MARK_FILESYSTEM),
 #define XLAT_VAL_7 ((unsigned) (FAN_MARK_FILESYSTEM))
 #define XLAT_STR_7 STRINGIFY(FAN_MARK_FILESYSTEM)
 XLAT(FAN_MARK_IGNORED_MASK),
 #define XLAT_VAL_8 ((unsigned) (FAN_MARK_IGNORED_MASK))
 #define XLAT_STR_8 STRINGIFY(FAN_MARK_IGNORED_MASK)
 XLAT(FAN_MARK_IGNORED_SURV_MODIFY),
 #define XLAT_VAL_9 ((unsigned) (FAN_MARK_IGNORED_SURV_MODIFY))
 #define XLAT_STR_9 STRINGIFY(FAN_MARK_IGNORED_SURV_MODIFY)
 ...
 #define XLAT_VAL_11 ((unsigned) (FAN_MARK_EVICTABLE))
 #define XLAT_STR_11 STRINGIFY(FAN_MARK_EVICTABLE)
};
static
