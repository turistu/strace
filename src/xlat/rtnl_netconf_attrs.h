...
static const struct xlat_data rtnl_netconf_attrs_xdata[] = {
 ...
 [NETCONFA_FORCE_FORWARDING] = XLAT(NETCONFA_FORCE_FORWARDING),
 #define XLAT_VAL_9 ((unsigned) (NETCONFA_FORCE_FORWARDING))
 #define XLAT_STR_9 STRINGIFY(NETCONFA_FORCE_FORWARDING)
};
static
