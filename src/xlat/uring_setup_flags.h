...
static const struct xlat_data uring_setup_flags_xdata[] = {
 ...
 XLAT(IORING_SETUP_HYBRID_IOPOLL),
 #define XLAT_VAL_17 ((unsigned) (IORING_SETUP_HYBRID_IOPOLL))
 #define XLAT_STR_17 STRINGIFY(IORING_SETUP_HYBRID_IOPOLL)
 XLAT(IORING_SETUP_CQE_MIXED),
 #define XLAT_VAL_18 ((unsigned) (IORING_SETUP_CQE_MIXED))
 #define XLAT_STR_18 STRINGIFY(IORING_SETUP_CQE_MIXED)
 XLAT(IORING_SETUP_SQE_MIXED),
 #define XLAT_VAL_19 ((unsigned) (IORING_SETUP_SQE_MIXED))
 #define XLAT_STR_19 STRINGIFY(IORING_SETUP_SQE_MIXED)
 XLAT(IORING_SETUP_SQ_REWIND),
 #define XLAT_VAL_20 ((unsigned) (IORING_SETUP_SQ_REWIND))
 #define XLAT_STR_20 STRINGIFY(IORING_SETUP_SQ_REWIND)
};
static
