...
static const struct xlat_data pr_sud_cmds_xdata[] = {
 ...
 [PR_SYS_DISPATCH_EXCLUSIVE_ON] = XLAT(PR_SYS_DISPATCH_EXCLUSIVE_ON),
 #define XLAT_VAL_1 ((unsigned) (PR_SYS_DISPATCH_EXCLUSIVE_ON))
 #define XLAT_STR_1 STRINGIFY(PR_SYS_DISPATCH_EXCLUSIVE_ON)
 [PR_SYS_DISPATCH_INCLUSIVE_ON] = XLAT(PR_SYS_DISPATCH_INCLUSIVE_ON),
 #define XLAT_VAL_2 ((unsigned) (PR_SYS_DISPATCH_INCLUSIVE_ON))
 #define XLAT_STR_2 STRINGIFY(PR_SYS_DISPATCH_INCLUSIVE_ON)
};
static
