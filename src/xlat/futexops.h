...
#endif
#if defined(FUTEX_UNLOCK_PI_LIST64) || (defined(HAVE_DECL_FUTEX_UNLOCK_PI_LIST64) && HAVE_DECL_FUTEX_UNLOCK_PI_LIST64)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_PI_LIST64) == ((FUTEX_UNLOCK_PI | FUTEX_ROBUST_UNLOCK)), "FUTEX_UNLOCK_PI_LIST64 != (FUTEX_UNLOCK_PI | FUTEX_ROBUST_UNLOCK)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_PI_LIST64 (FUTEX_UNLOCK_PI | FUTEX_ROBUST_UNLOCK)
#endif
#if defined(FUTEX_UNLOCK_PI_LIST64_PRIVATE) || (defined(HAVE_DECL_FUTEX_UNLOCK_PI_LIST64_PRIVATE) && HAVE_DECL_FUTEX_UNLOCK_PI_LIST64_PRIVATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_PI_LIST64_PRIVATE) == ((FUTEX_UNLOCK_PI_LIST64 | FUTEX_PRIVATE_FLAG)), "FUTEX_UNLOCK_PI_LIST64_PRIVATE != (FUTEX_UNLOCK_PI_LIST64 | FUTEX_PRIVATE_FLAG)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_PI_LIST64_PRIVATE (FUTEX_UNLOCK_PI_LIST64 | FUTEX_PRIVATE_FLAG)
#endif
#if defined(FUTEX_UNLOCK_PI_LIST32) || (defined(HAVE_DECL_FUTEX_UNLOCK_PI_LIST32) && HAVE_DECL_FUTEX_UNLOCK_PI_LIST32)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_PI_LIST32) == ((FUTEX_UNLOCK_PI | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)), "FUTEX_UNLOCK_PI_LIST32 != (FUTEX_UNLOCK_PI | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_PI_LIST32 (FUTEX_UNLOCK_PI | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)
#endif
#if defined(FUTEX_UNLOCK_PI_LIST32_PRIVATE) || (defined(HAVE_DECL_FUTEX_UNLOCK_PI_LIST32_PRIVATE) && HAVE_DECL_FUTEX_UNLOCK_PI_LIST32_PRIVATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_PI_LIST32_PRIVATE) == ((FUTEX_UNLOCK_PI_LIST32 | FUTEX_PRIVATE_FLAG)), "FUTEX_UNLOCK_PI_LIST32_PRIVATE != (FUTEX_UNLOCK_PI_LIST32 | FUTEX_PRIVATE_FLAG)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_PI_LIST32_PRIVATE (FUTEX_UNLOCK_PI_LIST32 | FUTEX_PRIVATE_FLAG)
#endif
#if defined(FUTEX_UNLOCK_WAKE_LIST64) || (defined(HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST64) && HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST64)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_WAKE_LIST64) == ((FUTEX_WAKE | FUTEX_ROBUST_UNLOCK)), "FUTEX_UNLOCK_WAKE_LIST64 != (FUTEX_WAKE | FUTEX_ROBUST_UNLOCK)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_WAKE_LIST64 (FUTEX_WAKE | FUTEX_ROBUST_UNLOCK)
#endif
#if defined(FUTEX_UNLOCK_WAKE_LIST64_PRIVATE) || (defined(HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST64_PRIVATE) && HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST64_PRIVATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_WAKE_LIST64_PRIVATE) == ((FUTEX_UNLOCK_WAKE_LIST64 | FUTEX_PRIVATE_FLAG)), "FUTEX_UNLOCK_WAKE_LIST64_PRIVATE != (FUTEX_UNLOCK_WAKE_LIST64 | FUTEX_PRIVATE_FLAG)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_WAKE_LIST64_PRIVATE (FUTEX_UNLOCK_WAKE_LIST64 | FUTEX_PRIVATE_FLAG)
#endif
#if defined(FUTEX_UNLOCK_WAKE_LIST32) || (defined(HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST32) && HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST32)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_WAKE_LIST32) == ((FUTEX_WAKE | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)), "FUTEX_UNLOCK_WAKE_LIST32 != (FUTEX_WAKE | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_WAKE_LIST32 (FUTEX_WAKE | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)
#endif
#if defined(FUTEX_UNLOCK_WAKE_LIST32_PRIVATE) || (defined(HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST32_PRIVATE) && HAVE_DECL_FUTEX_UNLOCK_WAKE_LIST32_PRIVATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_WAKE_LIST32_PRIVATE) == ((FUTEX_UNLOCK_WAKE_LIST32 | FUTEX_PRIVATE_FLAG)), "FUTEX_UNLOCK_WAKE_LIST32_PRIVATE != (FUTEX_UNLOCK_WAKE_LIST32 | FUTEX_PRIVATE_FLAG)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_WAKE_LIST32_PRIVATE (FUTEX_UNLOCK_WAKE_LIST32 | FUTEX_PRIVATE_FLAG)
#endif
#if defined(FUTEX_UNLOCK_BITSET_LIST64) || (defined(HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST64) && HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST64)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_BITSET_LIST64) == ((FUTEX_WAKE_BITSET | FUTEX_ROBUST_UNLOCK)), "FUTEX_UNLOCK_BITSET_LIST64 != (FUTEX_WAKE_BITSET | FUTEX_ROBUST_UNLOCK)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_BITSET_LIST64 (FUTEX_WAKE_BITSET | FUTEX_ROBUST_UNLOCK)
#endif
#if defined(FUTEX_UNLOCK_BITSET_LIST64_PRIVATE) || (defined(HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST64_PRIVATE) && HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST64_PRIVATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_BITSET_LIST64_PRIVATE) == ((FUTEX_UNLOCK_BITSET_LIST64 | FUTEX_PRIVATE_FLAG)), "FUTEX_UNLOCK_BITSET_LIST64_PRIVATE != (FUTEX_UNLOCK_BITSET_LIST64 | FUTEX_PRIVATE_FLAG)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_BITSET_LIST64_PRIVATE (FUTEX_UNLOCK_BITSET_LIST64 | FUTEX_PRIVATE_FLAG)
#endif
#if defined(FUTEX_UNLOCK_BITSET_LIST32) || (defined(HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST32) && HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST32)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_BITSET_LIST32) == ((FUTEX_WAKE_BITSET | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)), "FUTEX_UNLOCK_BITSET_LIST32 != (FUTEX_WAKE_BITSET | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FUTEX_UNLOCK_BITSET_LIST32 (FUTEX_WAKE_BITSET | FUTEX_ROBUST_UNLOCK | FUTEX_ROBUST_LIST32)
#endif
#if defined(FUTEX_UNLOCK_BITSET_LIST32_PRIVATE) || (defined(HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST32_PRIVATE) && HAVE_DECL_FUTEX_UNLOCK_BITSET_LIST32_PRIVATE)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FUTEX_UNLOCK_BITSET_LIST32_PRIVATE) == ((FUTEX_UNLOCK_BITSET_LIST32 | FUTEX_PRIVATE_FLAG)), "FUTEX_UNLOCK_BITSET_LIST32_PRIVATE != (FUTEX_UNLOCK_BITSET_LIST32 | FUTEX_PRIVATE_FLAG)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
#endif
 XLAT(FUTEX_UNLOCK_PI_LIST64),
 #define XLAT_VAL_34 ((unsigned) (FUTEX_UNLOCK_PI_LIST64))
 #define XLAT_STR_34 STRINGIFY(FUTEX_UNLOCK_PI_LIST64)
 XLAT(FUTEX_UNLOCK_PI_LIST64_PRIVATE),
 #define XLAT_VAL_35 ((unsigned) (FUTEX_UNLOCK_PI_LIST64_PRIVATE))
 #define XLAT_STR_35 STRINGIFY(FUTEX_UNLOCK_PI_LIST64_PRIVATE)
 XLAT(FUTEX_UNLOCK_PI_LIST32),
 #define XLAT_VAL_36 ((unsigned) (FUTEX_UNLOCK_PI_LIST32))
 #define XLAT_STR_36 STRINGIFY(FUTEX_UNLOCK_PI_LIST32)
 XLAT(FUTEX_UNLOCK_PI_LIST32_PRIVATE),
 #define XLAT_VAL_37 ((unsigned) (FUTEX_UNLOCK_PI_LIST32_PRIVATE))
 #define XLAT_STR_37 STRINGIFY(FUTEX_UNLOCK_PI_LIST32_PRIVATE)
 XLAT(FUTEX_UNLOCK_WAKE_LIST64),
 #define XLAT_VAL_38 ((unsigned) (FUTEX_UNLOCK_WAKE_LIST64))
 #define XLAT_STR_38 STRINGIFY(FUTEX_UNLOCK_WAKE_LIST64)
 XLAT(FUTEX_UNLOCK_WAKE_LIST64_PRIVATE),
 #define XLAT_VAL_39 ((unsigned) (FUTEX_UNLOCK_WAKE_LIST64_PRIVATE))
 #define XLAT_STR_39 STRINGIFY(FUTEX_UNLOCK_WAKE_LIST64_PRIVATE)
 XLAT(FUTEX_UNLOCK_WAKE_LIST32),
 #define XLAT_VAL_40 ((unsigned) (FUTEX_UNLOCK_WAKE_LIST32))
 #define XLAT_STR_40 STRINGIFY(FUTEX_UNLOCK_WAKE_LIST32)
 XLAT(FUTEX_UNLOCK_WAKE_LIST32_PRIVATE),
 #define XLAT_VAL_41 ((unsigned) (FUTEX_UNLOCK_WAKE_LIST32_PRIVATE))
 #define XLAT_STR_41 STRINGIFY(FUTEX_UNLOCK_WAKE_LIST32_PRIVATE)
 XLAT(FUTEX_UNLOCK_BITSET_LIST64),
 #define XLAT_VAL_42 ((unsigned) (FUTEX_UNLOCK_BITSET_LIST64))
 #define XLAT_STR_42 STRINGIFY(FUTEX_UNLOCK_BITSET_LIST64)
 XLAT(FUTEX_UNLOCK_BITSET_LIST64_PRIVATE),
 #define XLAT_VAL_43 ((unsigned) (FUTEX_UNLOCK_BITSET_LIST64_PRIVATE))
 #define XLAT_STR_43 STRINGIFY(FUTEX_UNLOCK_BITSET_LIST64_PRIVATE)
 XLAT(FUTEX_UNLOCK_BITSET_LIST32),
 #define XLAT_VAL_44 ((unsigned) (FUTEX_UNLOCK_BITSET_LIST32))
 #define XLAT_STR_44 STRINGIFY(FUTEX_UNLOCK_BITSET_LIST32)
 XLAT(FUTEX_UNLOCK_BITSET_LIST32_PRIVATE),
 #define XLAT_VAL_45 ((unsigned) (FUTEX_UNLOCK_BITSET_LIST32_PRIVATE))
 #define XLAT_STR_45 STRINGIFY(FUTEX_UNLOCK_BITSET_LIST32_PRIVATE)
};
static
