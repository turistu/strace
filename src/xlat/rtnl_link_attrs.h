...
static const struct xlat_data rtnl_link_attrs_xdata[] = {
 ...
 [IFLA_DPLL_PIN] = XLAT(IFLA_DPLL_PIN),
 #define XLAT_VAL_65 ((unsigned) (IFLA_DPLL_PIN))
 #define XLAT_STR_65 STRINGIFY(IFLA_DPLL_PIN)
 [IFLA_MAX_PACING_OFFLOAD_HORIZON] = XLAT(IFLA_MAX_PACING_OFFLOAD_HORIZON),
 #define XLAT_VAL_66 ((unsigned) (IFLA_MAX_PACING_OFFLOAD_HORIZON))
 #define XLAT_STR_66 STRINGIFY(IFLA_MAX_PACING_OFFLOAD_HORIZON)
 [IFLA_NETNS_IMMUTABLE] = XLAT(IFLA_NETNS_IMMUTABLE),
 #define XLAT_VAL_67 ((unsigned) (IFLA_NETNS_IMMUTABLE))
 #define XLAT_STR_67 STRINGIFY(IFLA_NETNS_IMMUTABLE)
 [IFLA_HEADROOM] = XLAT(IFLA_HEADROOM),
 #define XLAT_VAL_68 ((unsigned) (IFLA_HEADROOM))
 #define XLAT_STR_68 STRINGIFY(IFLA_HEADROOM)
 [IFLA_TAILROOM] = XLAT(IFLA_TAILROOM),
 #define XLAT_VAL_69 ((unsigned) (IFLA_TAILROOM))
 #define XLAT_STR_69 STRINGIFY(IFLA_TAILROOM)
};
static
