...
#endif
#if defined(PIDFD_AUTOKILL) || (defined(HAVE_DECL_PIDFD_AUTOKILL) && HAVE_DECL_PIDFD_AUTOKILL)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((PIDFD_AUTOKILL) == (O_TRUNC), "PIDFD_AUTOKILL != O_TRUNC");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data pidfd_open_flags_xdata[] = {
 ...
 XLAT(PIDFD_AUTOKILL),
 #define XLAT_VAL_2 ((unsigned) (PIDFD_AUTOKILL))
 #define XLAT_STR_2 STRINGIFY(PIDFD_AUTOKILL)
};
static
