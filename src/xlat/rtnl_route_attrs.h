...
static const struct xlat_data rtnl_route_attrs_xdata[] = {
 ...
 [RTA_FLOWLABEL] = XLAT(RTA_FLOWLABEL),
 #define XLAT_VAL_31 ((unsigned) (RTA_FLOWLABEL))
 #define XLAT_STR_31 STRINGIFY(RTA_FLOWLABEL)
 [RTA_DEL_REASON] = XLAT(RTA_DEL_REASON),
 #define XLAT_VAL_32 ((unsigned) (RTA_DEL_REASON))
 #define XLAT_STR_32 STRINGIFY(RTA_DEL_REASON)
};
static
