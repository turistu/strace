...
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((COUNTER_EVENT_DIRECTION_CHANGE) == (7), "COUNTER_EVENT_DIRECTION_CHANGE != 7");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#undef XLAT_PREV_VAL
...
static const struct xlat_data counter_ioctl_event_types_xdata[] = {
 ...
 [COUNTER_EVENT_DIRECTION_CHANGE] = XLAT(COUNTER_EVENT_DIRECTION_CHANGE),
 #define XLAT_VAL_7 ((unsigned) (COUNTER_EVENT_DIRECTION_CHANGE))
 #define XLAT_STR_7 STRINGIFY(COUNTER_EVENT_DIRECTION_CHANGE)
};
static
