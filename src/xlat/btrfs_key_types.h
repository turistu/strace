...
#endif
#if defined(BTRFS_IDENTITY_REMAP_KEY) || (defined(HAVE_DECL_BTRFS_IDENTITY_REMAP_KEY) && HAVE_DECL_BTRFS_IDENTITY_REMAP_KEY)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (BTRFS_IDENTITY_REMAP_KEY)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: BTRFS_IDENTITY_REMAP_KEY"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (BTRFS_IDENTITY_REMAP_KEY)
#endif
#if defined(BTRFS_REMAP_KEY) || (defined(HAVE_DECL_BTRFS_REMAP_KEY) && HAVE_DECL_BTRFS_REMAP_KEY)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (BTRFS_REMAP_KEY)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: BTRFS_REMAP_KEY"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (BTRFS_REMAP_KEY)
#endif
#if defined(BTRFS_REMAP_BACKREF_KEY) || (defined(HAVE_DECL_BTRFS_REMAP_BACKREF_KEY) && HAVE_DECL_BTRFS_REMAP_BACKREF_KEY)
#if defined XLAT_PREV_VAL
static_assert((unsigned long long) (BTRFS_REMAP_BACKREF_KEY)
      > (unsigned long long) (XLAT_PREV_VAL),
      "Incorrect order in #sorted xlat: BTRFS_REMAP_BACKREF_KEY"
      " is not larger than the previous value");
#endif
#undef XLAT_PREV_VAL
#define XLAT_PREV_VAL (BTRFS_REMAP_BACKREF_KEY)
#endif
...
#endif
#if defined(BTRFS_IDENTITY_REMAP_KEY) || (defined(HAVE_DECL_BTRFS_IDENTITY_REMAP_KEY) && HAVE_DECL_BTRFS_IDENTITY_REMAP_KEY)
  XLAT_TYPE(uint64_t, BTRFS_IDENTITY_REMAP_KEY),
 #define XLAT_VAL_32 ((uint64_t) (BTRFS_IDENTITY_REMAP_KEY))
 #define XLAT_STR_32 STRINGIFY(BTRFS_IDENTITY_REMAP_KEY)
#endif
#if defined(BTRFS_REMAP_KEY) || (defined(HAVE_DECL_BTRFS_REMAP_KEY) && HAVE_DECL_BTRFS_REMAP_KEY)
  XLAT_TYPE(uint64_t, BTRFS_REMAP_KEY),
 #define XLAT_VAL_33 ((uint64_t) (BTRFS_REMAP_KEY))
 #define XLAT_STR_33 STRINGIFY(BTRFS_REMAP_KEY)
#endif
#if defined(BTRFS_REMAP_BACKREF_KEY) || (defined(HAVE_DECL_BTRFS_REMAP_BACKREF_KEY) && HAVE_DECL_BTRFS_REMAP_BACKREF_KEY)
  XLAT_TYPE(uint64_t, BTRFS_REMAP_BACKREF_KEY),
 #define XLAT_VAL_34 ((uint64_t) (BTRFS_REMAP_BACKREF_KEY))
 #define XLAT_STR_34 STRINGIFY(BTRFS_REMAP_BACKREF_KEY)
#endif
#if defined(BTRFS_QGROUP_STATUS_KEY) || (defined(HAVE_DECL_BTRFS_QGROUP_STATUS_KEY) && HAVE_DECL_BTRFS_QGROUP_STATUS_KEY)
  XLAT_TYPE(uint64_t, BTRFS_QGROUP_STATUS_KEY),
 #define XLAT_VAL_35 ((uint64_t) (BTRFS_QGROUP_STATUS_KEY))
 #define XLAT_STR_35 STRINGIFY(BTRFS_QGROUP_STATUS_KEY)
#endif
#if defined(BTRFS_QGROUP_INFO_KEY) || (defined(HAVE_DECL_BTRFS_QGROUP_INFO_KEY) && HAVE_DECL_BTRFS_QGROUP_INFO_KEY)
  XLAT_TYPE(uint64_t, BTRFS_QGROUP_INFO_KEY),
 #define XLAT_VAL_36 ((uint64_t) (BTRFS_QGROUP_INFO_KEY))
 #define XLAT_STR_36 STRINGIFY(BTRFS_QGROUP_INFO_KEY)
#endif
#if defined(BTRFS_QGROUP_LIMIT_KEY) || (defined(HAVE_DECL_BTRFS_QGROUP_LIMIT_KEY) && HAVE_DECL_BTRFS_QGROUP_LIMIT_KEY)
  XLAT_TYPE(uint64_t, BTRFS_QGROUP_LIMIT_KEY),
 #define XLAT_VAL_37 ((uint64_t) (BTRFS_QGROUP_LIMIT_KEY))
 #define XLAT_STR_37 STRINGIFY(BTRFS_QGROUP_LIMIT_KEY)
#endif
#if defined(BTRFS_QGROUP_RELATION_KEY) || (defined(HAVE_DECL_BTRFS_QGROUP_RELATION_KEY) && HAVE_DECL_BTRFS_QGROUP_RELATION_KEY)
  XLAT_TYPE(uint64_t, BTRFS_QGROUP_RELATION_KEY),
 #define XLAT_VAL_38 ((uint64_t) (BTRFS_QGROUP_RELATION_KEY))
 #define XLAT_STR_38 STRINGIFY(BTRFS_QGROUP_RELATION_KEY)
#endif
#if defined(BTRFS_TEMPORARY_ITEM_KEY) || (defined(HAVE_DECL_BTRFS_TEMPORARY_ITEM_KEY) && HAVE_DECL_BTRFS_TEMPORARY_ITEM_KEY)
  XLAT_TYPE(uint64_t, BTRFS_TEMPORARY_ITEM_KEY),
 #define XLAT_VAL_39 ((uint64_t) (BTRFS_TEMPORARY_ITEM_KEY))
 #define XLAT_STR_39 STRINGIFY(BTRFS_TEMPORARY_ITEM_KEY)
#endif
#if defined(BTRFS_PERSISTENT_ITEM_KEY) || (defined(HAVE_DECL_BTRFS_PERSISTENT_ITEM_KEY) && HAVE_DECL_BTRFS_PERSISTENT_ITEM_KEY)
  XLAT_TYPE(uint64_t, BTRFS_PERSISTENT_ITEM_KEY),
 #define XLAT_VAL_40 ((uint64_t) (BTRFS_PERSISTENT_ITEM_KEY))
 #define XLAT_STR_40 STRINGIFY(BTRFS_PERSISTENT_ITEM_KEY)
#endif
#if defined(BTRFS_DEV_REPLACE_KEY) || (defined(HAVE_DECL_BTRFS_DEV_REPLACE_KEY) && HAVE_DECL_BTRFS_DEV_REPLACE_KEY)
  XLAT_TYPE(uint64_t, BTRFS_DEV_REPLACE_KEY),
 #define XLAT_VAL_41 ((uint64_t) (BTRFS_DEV_REPLACE_KEY))
 #define XLAT_STR_41 STRINGIFY(BTRFS_DEV_REPLACE_KEY)
#endif
#if defined(BTRFS_UUID_KEY_SUBVOL) || (defined(HAVE_DECL_BTRFS_UUID_KEY_SUBVOL) && HAVE_DECL_BTRFS_UUID_KEY_SUBVOL)
  XLAT_TYPE(uint64_t, BTRFS_UUID_KEY_SUBVOL),
 #define XLAT_VAL_42 ((uint64_t) (BTRFS_UUID_KEY_SUBVOL))
 #define XLAT_STR_42 STRINGIFY(BTRFS_UUID_KEY_SUBVOL)
#endif
#if defined(BTRFS_UUID_KEY_RECEIVED_SUBVOL) || (defined(HAVE_DECL_BTRFS_UUID_KEY_RECEIVED_SUBVOL) && HAVE_DECL_BTRFS_UUID_KEY_RECEIVED_SUBVOL)
  XLAT_TYPE(uint64_t, BTRFS_UUID_KEY_RECEIVED_SUBVOL),
 #define XLAT_VAL_43 ((uint64_t) (BTRFS_UUID_KEY_RECEIVED_SUBVOL))
 #define XLAT_STR_43 STRINGIFY(BTRFS_UUID_KEY_RECEIVED_SUBVOL)
#endif
#if defined(BTRFS_STRING_ITEM_KEY) || (defined(HAVE_DECL_BTRFS_STRING_ITEM_KEY) && HAVE_DECL_BTRFS_STRING_ITEM_KEY)
  XLAT_TYPE(uint64_t, BTRFS_STRING_ITEM_KEY),
 #define XLAT_VAL_44 ((uint64_t) (BTRFS_STRING_ITEM_KEY))
 #define XLAT_STR_44 STRINGIFY(BTRFS_STRING_ITEM_KEY)
#endif
#if defined(UINT32_MAX) || (defined(HAVE_DECL_UINT32_MAX) && HAVE_DECL_UINT32_MAX)
  XLAT_TYPE(uint64_t, UINT32_MAX),
 #define XLAT_VAL_45 ((uint64_t) (UINT32_MAX))
 #define XLAT_STR_45 STRINGIFY(UINT32_MAX)
#endif
};
