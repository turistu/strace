...
static const struct xlat_data tee_ioctl_param_attr_types_xdata[] = {
 ...
 XLAT(TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INPUT),
 #define XLAT_VAL_7 ((unsigned) (TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INPUT))
 #define XLAT_STR_7 STRINGIFY(TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INPUT)
 XLAT(TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_OUTPUT),
 #define XLAT_VAL_8 ((unsigned) (TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_OUTPUT))
 #define XLAT_STR_8 STRINGIFY(TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_OUTPUT)
 XLAT(TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INOUT),
 #define XLAT_VAL_9 ((unsigned) (TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INOUT))
 #define XLAT_STR_9 STRINGIFY(TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INOUT)
 XLAT(TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INPUT),
 #define XLAT_VAL_10 ((unsigned) (TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INPUT))
 #define XLAT_STR_10 STRINGIFY(TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INPUT)
 XLAT(TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_OUTPUT),
 #define XLAT_VAL_11 ((unsigned) (TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_OUTPUT))
 #define XLAT_STR_11 STRINGIFY(TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_OUTPUT)
 XLAT(TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INOUT),
 #define XLAT_VAL_12 ((unsigned) (TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INOUT))
 #define XLAT_STR_12 STRINGIFY(TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INOUT)
 XLAT(TEE_IOCTL_PARAM_ATTR_META),
 #define XLAT_VAL_13 ((unsigned) (TEE_IOCTL_PARAM_ATTR_META))
 #define XLAT_STR_13 STRINGIFY(TEE_IOCTL_PARAM_ATTR_META)
};
static
