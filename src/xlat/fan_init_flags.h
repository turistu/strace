...
#endif
#if defined(FAN_REPORT_FD_ERROR) || (defined(HAVE_DECL_FAN_REPORT_FD_ERROR) && HAVE_DECL_FAN_REPORT_FD_ERROR)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FAN_REPORT_FD_ERROR) == (0x00002000), "FAN_REPORT_FD_ERROR != 0x00002000");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define FAN_REPORT_FD_ERROR 0x00002000
#endif
#if defined(FAN_REPORT_MNT) || (defined(HAVE_DECL_FAN_REPORT_MNT) && HAVE_DECL_FAN_REPORT_MNT)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((FAN_REPORT_MNT) == (0x00004000), "FAN_REPORT_MNT != 0x00004000");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data fan_init_flags_xdata[] = {
 ...
 #define XLAT_VAL_11 ((unsigned) (FAN_REPORT_FD_ERROR))
 #define XLAT_STR_11 STRINGIFY(FAN_REPORT_FD_ERROR)
 XLAT(FAN_REPORT_MNT),
 #define XLAT_VAL_12 ((unsigned) (FAN_REPORT_MNT))
 #define XLAT_STR_12 STRINGIFY(FAN_REPORT_MNT)
};
static
