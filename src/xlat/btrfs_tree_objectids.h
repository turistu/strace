...
static const struct xlat_data btrfs_tree_objectids_xdata[] = {
 ...
 #define XLAT_VAL_11 ((uint64_t) (BTRFS_RAID_STRIPE_TREE_OBJECTID))
 #define XLAT_STR_11 STRINGIFY(BTRFS_RAID_STRIPE_TREE_OBJECTID)
 XLAT_TYPE(uint64_t, BTRFS_REMAP_TREE_OBJECTID),
 #define XLAT_VAL_12 ((uint64_t) (BTRFS_REMAP_TREE_OBJECTID))
 #define XLAT_STR_12 STRINGIFY(BTRFS_REMAP_TREE_OBJECTID)
 XLAT_TYPE(uint64_t, BTRFS_FIRST_FREE_OBJECTID),
 #define XLAT_VAL_13 ((uint64_t) (BTRFS_FIRST_FREE_OBJECTID))
 #define XLAT_STR_13 STRINGIFY(BTRFS_FIRST_FREE_OBJECTID)
 XLAT_TYPE(uint64_t, BTRFS_LAST_FREE_OBJECTID),
 #define XLAT_VAL_14 ((uint64_t) (BTRFS_LAST_FREE_OBJECTID))
 #define XLAT_STR_14 STRINGIFY(BTRFS_LAST_FREE_OBJECTID)
 XLAT_TYPE(uint64_t, UINT64_MAX),
 #define XLAT_VAL_15 ((uint64_t) (UINT64_MAX))
 #define XLAT_STR_15 STRINGIFY(UINT64_MAX)
};
