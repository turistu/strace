...
#endif
#if defined(NTF_EXT_EXT_VALIDATED) || (defined(HAVE_DECL_NTF_EXT_EXT_VALIDATED) && HAVE_DECL_NTF_EXT_EXT_VALIDATED)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((NTF_EXT_EXT_VALIDATED) == ((1 << 2)), "NTF_EXT_EXT_VALIDATED != (1 << 2)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data neighbor_cache_entry_ext_flags_xdata[] = {
 ...
 XLAT(NTF_EXT_EXT_VALIDATED),
 #define XLAT_VAL_2 ((unsigned) (NTF_EXT_EXT_VALIDATED))
 #define XLAT_STR_2 STRINGIFY(NTF_EXT_EXT_VALIDATED)
};
static
