 ...
 * Copyright (c) 2000-2026 The strace developers.
 * All rights reserved.
 *
...
[BASE_NR +   9] = { 3,	CC|TF|TP|TSD|SI,	SEN(execve),			"execve"		},
...
[BASE_NR + 212] = { 1,	TP,		SEN(exit),			"exit_group"		},
...
[BASE_NR + 318] = { 5,	CC|TD|TF|TP|TSD|SI,	SEN(execveat),			"execveat"		},
