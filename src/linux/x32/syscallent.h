/*
 * Copyright (c) 2012-2026 The strace developers.
 * All rights reserved.
 *
...
[ 59] = { 3,	CC|TF|TP|TSD|SI,	SEN(printargs),			"execve#64"		},
[ 60] = { 1,	TP,		SEN(exit),			"exit"			},
...
[322] = { 5,	CC|TD|TF|TP|TSD|SI,	SEN(printargs),			"execveat#64"		},
...
[520] = { 3,	CST|CC|TF|TP|TSD|SI,SEN(execve),			"execve"		},
...
[545] = { 5,	CST|CC|TD|TF|TP|TSD|SI,	SEN(execveat),		"execveat"		},
