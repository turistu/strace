...
[BASE_NR +  57] = { 3,	CC|TF|TP|TSD|SI,	SEN(execve),			"execve"		},
[BASE_NR +  58] = { 1,	TP,		SEN(exit),			"exit"			},
...
[BASE_NR + 205] = { 1,	TP,		SEN(exit),			"exit_group"		},
...
[BASE_NR + 316] = { 5,	CC|TD|TF|TP|TSD|SI,	SEN(execveat),			"execveat"		},
