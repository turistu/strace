...
AC_DEFUN([st_BPF_ATTR], [dnl
	AC_CHECK_MEMBERS(m4_normalize([
		...
		struct bpf_prog_info.attach_btf_id,
		struct bpf_prog_info.attach_btf_obj_id,
		...
		union bpf_attr.btf_token_fd,
		union bpf_attr.btf_value_type_id,
		union bpf_attr.btf_vmlinux_value_type_id,
		union bpf_attr.core_relo_cnt,
		union bpf_attr.core_relo_rec_size,
		union bpf_attr.core_relos,
		union bpf_attr.enable_stats.type,
		union bpf_attr.excl_prog_hash,
		union bpf_attr.excl_prog_hash_size,
		union bpf_attr.expected_attach_type,
		union bpf_attr.expected_revision,
		union bpf_attr.fd_array,
		union bpf_attr.fd_array_cnt,
		union bpf_attr.fd_by_id_token_fd,
		...
		union bpf_attr.iter_create.flags,
		union bpf_attr.iter_create.link_fd,
		union bpf_attr.kern_version,
		union bpf_attr.key,
		union bpf_attr.key_size,
		union bpf_attr.keyring_id,
		union bpf_attr.license,
		union bpf_attr.line_info,
		union bpf_attr.line_info_cnt,
		union bpf_attr.line_info_rec_size,
		union bpf_attr.link_create.addrs,
		union bpf_attr.link_create.attach_type,
		union bpf_attr.link_create.bpf_cookie,
		union bpf_attr.link_create.cnt,
		union bpf_attr.link_create.cookies,
		union bpf_attr.link_create.expected_revision,
		union bpf_attr.link_create.flags,
		union bpf_attr.link_create.hooknum,
		union bpf_attr.link_create.ids,
		union bpf_attr.link_create.iter_info,
		union bpf_attr.link_create.iter_info_len,
		union bpf_attr.link_create.kprobe_multi,
		union bpf_attr.link_create.netfilter,
		union bpf_attr.link_create.offsets,
		union bpf_attr.link_create.path,
		union bpf_attr.link_create.path_fd,
		union bpf_attr.link_create.perf_event,
		union bpf_attr.link_create.pf,
		union bpf_attr.link_create.pid,
		union bpf_attr.link_create.priority,
		union bpf_attr.link_create.prog_fd,
		union bpf_attr.link_create.ref_ctr_offsets,
		union bpf_attr.link_create.relative_fd,
		union bpf_attr.link_create.relative_id,
		union bpf_attr.link_create.syms,
		union bpf_attr.link_create.target_btf_id,
		union bpf_attr.link_create.target_fd,
		union bpf_attr.link_create.target_ifindex,
		union bpf_attr.link_create.tracing_multi,
		union bpf_attr.link_create.uprobe_multi,
		union bpf_attr.link_detach.link_fd,
		union bpf_attr.link_id,
		...
		union bpf_attr.path_fd,
		union bpf_attr.pathname,
		union bpf_attr.prog_assoc_struct_ops,
		union bpf_attr.prog_bind_map.flags,
		union bpf_attr.prog_bind_map.map_fd,
		union bpf_attr.prog_bind_map.prog_fd,
		...
		union bpf_attr.prog_stream_read.prog_fd,
		union bpf_attr.prog_stream_read.stream_buf,
		union bpf_attr.prog_stream_read.stream_buf_len,
		union bpf_attr.prog_stream_read.stream_id,
		union bpf_attr.prog_token_fd,
		union bpf_attr.prog_type,
		union bpf_attr.query.attach_flags,
		union bpf_attr.query.attach_type,
		union bpf_attr.query.dummy,
		union bpf_attr.query.link_attach_flags,
		union bpf_attr.query.link_ids,
		union bpf_attr.query.prog_attach_flags,
		union bpf_attr.query.prog_cnt,
		union bpf_attr.query.prog_ids,
		union bpf_attr.query.query_flags,
		union bpf_attr.query.revision,
		union bpf_attr.query.target_fd,
		union bpf_attr.query.target_ifindex,
		...
		union bpf_attr.relative_fd,
		union bpf_attr.relative_id,
		union bpf_attr.replace_bpf_fd,
		union bpf_attr.signature,
		union bpf_attr.signature_size,
		union bpf_attr.start_id,
		union bpf_attr.target_fd,
		union bpf_attr.target_ifindex,
		...
		union bpf_attr.test.batch_size,
		union bpf_attr.test.cpu,
		...
		union bpf_attr.value_type_btf_obj_fd,
